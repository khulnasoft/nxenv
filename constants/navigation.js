...
const general = [
  ...
  makeSection('Development process', [
    ...
    makeSection('Existing React Native apps', [
      ...
      makePage('bare/installing-nxenv-modules.mdx'),
      makePage('bare/using-nxenv-cli.mdx'),
    ...
    makeSection('Existing native apps', [
      ...
      makePage('brownfield/installing-nxenv-modules.mdx'),
    ]),
    makeGroup(
      'Reference',
      [
  ...
  makeSection('Nxenv Router', [
    ...
    makeGroup('Migration', [
      ...
      makePage('router/migrate/from-nxenv-webpack.mdx'),
    ]),
  ]),
  makeSection(
    'Nxenv Modules API',
    [
      ...
      makeSection('Tutorials', [
        ...
        makePage('modules/use-standalone-nxenv-module-in-your-project.mdx'),
  ...
  makeSection('EAS Update', [
    ...
    makeGroup('Preview', [
      ...
      makePage('eas-update/nxenv-dev-client.mdx'),
  ...
  makeSection(
    'More',
    [
      makePage('workflow/upgrading-nxenv-sdk-walkthrough.mdx'),
...
const archive = [
  ...
  makeSection('Technical Specs', [makePage('archive/technical-specs/nxenv-updates-0.mdx')]),
  makeSection('Push Notifications', [
  ...
  makeSection('More', [
    makePage('archive/nxenv-cli.mdx'),
    ...
    makePage('archive/using-nxenv-client.mdx'),
...
const versionsReference = VERSIONS.reduce(
  (all, version) => ({
    ...
    [version]: [
      ...
      makeSection(
        'Nxenv SDK',
        shiftEntryToFront(pagesFromDir(`versions/${version}/sdk`), entry => entry.name === 'Nxenv'),
        { expanded: true }
      ),
      makeSection('Technical specs', [
        makePage('technical-specs/nxenv-updates-1.mdx'),
        makePage('technical-specs/nxenv-sfv-0.mdx'),
      ]),
      makeSection(
        'More',
        [
          makePage('more/nxenv-cli.mdx'),
          makePage('more/create-nxenv.mdx'),
...
function pageUrl(file) {
  ...
  const { pathname } = new URL(path.relative(PAGES_DIR, file), 'https://docs.nxenv.dev');
  return pathname
