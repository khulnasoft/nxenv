...
<Terminal cmd={['$ npx nxenv run:ios --device']} />

> This command runs a development server after building your app. You can skip running `npx nxenv start` on the next page.
