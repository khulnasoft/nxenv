...
### Create an Nxenv account and login

To build your app, you will need to create an Nxenv account and login to the EAS CLI.

1. [Sign up](https://nxenv.dev/signup) for an Nxenv account.
