...
If you are on macOS or Linux, add an [environment variable](https://developer.android.com/studio/command-line/variables#envar) pointing to the Android SDK location in **~/.bash_profile** (or **~/.zshrc** if you use Zsh). For example: `nxenvrt ANDROID_HOME=/your/path/here`.

Add the following lines to your **/.zprofile** or **~/.zshrc** (if you are using bash, then **~/.bash_profile** or **~/.bashrc**) config file:

<Terminal
  cmd={[
    '$ nxenvrt ANDROID_HOME=$HOME/Library/Android/sdk',
    '$ nxenvrt PATH=$PATH:$ANDROID_HOME/emulator',
    '$ nxenvrt PATH=$PATH:$ANDROID_HOME/platform-tools',
  ]}
  cmdCopy="nxenvrt ANDROID_HOME=$HOME/Library/Android/sdk && nxenvrt PATH=$PATH:$ANDROID_HOME/emulator && nxenvrt PATH=$PATH:$ANDROID_HOME/platform-tools"
/>
