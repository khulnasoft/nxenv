...
You can redirect a request to a different URL based on some in-app criteria. Nxenv Router supports a number of different redirection patterns.
...
import { useRouter, useFocusEffect } from 'nxenv-router';
