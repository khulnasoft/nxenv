...
In Nxenv Router, there's always a valid URL that represents the currently focused route. Use hooks to observe changes and interact with the URL.
...
```tsx
/* @info */
import { useFocusEffect } from 'nxenv-router';
/* @end */
...
/* @info */
import { useGlobalSearchParams } from 'nxenv-router';
/* @end */
...
nxenvrt default function MenuRoute() {
...
import { Text } from 'react-native';
/* @info */
import { usePathname } from 'nxenv-router';
/* @end */
...
import { Text } from 'react-native';
/* @info */
import { useSegments } from 'nxenv-router';
/* @end */
