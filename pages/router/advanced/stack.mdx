---
title: Stack
description: Learn how to use the Stack navigator in Nxenv Router.
---
...
A stack navigator is the foundational way of navigating between routes in an app. On Android, a stacked route animates on top of the current screen. On iOS, a stacked route animates from the right. Nxenv Router provides a `Stack` navigation component that creates a navigation stack and allows you to add new routes in your app.
...
```tsx app/_layout.tsx
import { Stack } from 'nxenv-router/stack';
...
```tsx app/index.tsx
import { Stack, useNavigation } from 'nxenv-router';
...
```tsx app/details.tsx
import { Stack, useLocalSearchParams, useRouter } from 'nxenv-router';
import { View, Text, StyleSheet } from 'react-native';

nxenvrt default function Details() {
...
/* @info Import <CODE>useRouter</CODE> from Nxenv Router. */
import { useRouter } from 'nxenv-router';
/* @end */

nxenvrt default function Settings() {
...
The `Stack` navigator in Nxenv Router wraps the [Native Stack Navigator](https://reactnavigation.org/docs/native-stack-navigator) from React Navigation. Options available in the Native Stack Navigator are all available in the `Stack` navigator in Nxenv Router.
...
import { withLayoutContext } from 'nxenv-router';

const { Navigator } = createStackNavigator();

nxenvrt const JsStack = withLayoutContext<
  StackNavigationOptions,
  typeof Navigator,
