---
title: Root layout
description: Learn how to use the root layout to add global providers to your app when using Nxenv Router.
hideTOC: true
---
...
In Nxenv Router, you can use the **Root Layout** (**app/\_layout.tsx**) to add providers which can be accessed by any route in the app.
