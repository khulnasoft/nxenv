...
- Use Nxenv Router's special file-based syntax to create a modal screen within the app's navigation system.
...
<ContentSpotlight file="nxenv-router/react-native-modal.mp4" />
...
## Modal screen using Nxenv Router
...
<ContentSpotlight file="nxenv-router/modal.mp4" />
...
nxenvrt default function Modal() {
  return (
    <View style={styles.container}>
...
{/* prettier-ignore */}
```tsx app/modal.tsx
import { Link, /* @info Import the <CODE>router</CODE> object which is used to navigate imperatively. */ router /* @end */} from 'nxenv-router';
import { StyleSheet, Text, View } from 'react-native';
...
<ContentSpotlight file="nxenv-router/web-modal.mp4" />
