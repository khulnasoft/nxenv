---
title: Drawer
description: Learn how to use the Drawer layout in Nxenv Router.
---
...
<Terminal
  cmd={[
    '$ npx nxenv install @react-navigation/drawer react-native-gesture-handler react-native-reanimated',
  ]}
/>
...
No additional configuration is required for SDK 50 and above. [Reanimated Babel plugin](https://docs.swmansion.com/react-native-reanimated/docs/fundamentals/glossary#reanimated-babel-plugin) is automatically configured in `babel-preset-nxenv` when you install the library.
...
import { Drawer } from 'nxenv-router/drawer';
