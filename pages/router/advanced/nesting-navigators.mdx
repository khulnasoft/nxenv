...
description: Learn how to nest navigators in Nxenv Router.
---

import { FileTree } from '~/ui/components/FileTree';

> **warning** Navigation UI elements (Link, Tabs, Stack) may move out of the Nxenv Router library in the future.

Nesting navigators allow rendering a navigator inside the screen of another navigator. This guide is an extension of [React Navigation: Nesting navigators](https://reactnavigation.org/docs/nesting-navigators) to Nxenv Router. It provides an example of how nesting navigators work when using Nxenv Router.
...
nxenvrt default function Messages() {
  return (
    <View>
...
In Nxenv Router, you can use `router.push()` to achieve the same result. There is no need to pass the screen name in the params explicitly.
