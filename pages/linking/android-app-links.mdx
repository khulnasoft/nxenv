...
description: Learn how to configure Android App Links to open your Nxenv app from a standard web URL.
---
...
If you're using Nxenv Router to build your website (or any other modern React framework such as Remix, Next.js, and so on), create **assetlinks.json** at **public/.well-known/assetlinks.json**. For legacy Nxenv webpack projects, create the file at **web/.well-known/assetlinks.json**.
...
The Nxenv CLI enables you to test Android App Links without deploying a website. Utilizing the [`--tunnel`](/more/nxenv-cli/#tunneling) functionality, you can forward your dev server to a publicly available HTTPS URL.
