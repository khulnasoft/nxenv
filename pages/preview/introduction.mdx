...
This section of the documentation provides a preview of experimental new features that we're working on at Nxenv. It is not linked from the main documentation but it is also not particularly well hidden.
...
Direct all of your support questions and feedback to either a partner Slack channel (if you have one, you know what it is) or use **Share your feedback** or email us at [preview@nxenv.dev](mailto:preview@nxenv.dev).
