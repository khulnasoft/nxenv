...
- You have to create a [Google Service Account](https://nxenv.fyi/creating-google-service-account) and download its JSON private key.
...
For more information, see [nxenv.fyi/creating-google-service-account](https://nxenv.fyi/creating-google-service-account).
...
For more information, see [nxenv.fyi/first-android-submission](https://nxenv.fyi/first-android-submission).
