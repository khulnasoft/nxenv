...
description: Learn about dynamic routes and how you can create them using Nxenv Router library.
---
...
This guide explains how to handle dynamic routes with Nxenv Router.
