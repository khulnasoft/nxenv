---
title: Safe areas
description: Learn how to add safe areas for screen components inside your Nxenv project.
---
...
You can skip installing `react-native-safe-area-context` if you have created a project using [the default template](/get-started/create-a-project/). This library is installed as peer dependency for Nxenv Router library. Otherwise, install it by running the following command:

<Terminal cmd={['$ npx nxenv install react-native-safe-area-context']} />
...
<Collapsible summary="Using a different Nxenv template and don't have Nxenv Router installed?">
