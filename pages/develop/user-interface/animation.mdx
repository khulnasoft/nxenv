...
<Terminal cmd={['$ npx nxenv install react-native-reanimated']} />
...
You can use other animation packages such as [Moti](https://moti.fyi/) in your Nxenv project. It works on Android, iOS, and web.
