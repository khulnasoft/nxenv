...
description: In this chapter, learn how to create a new Nxenv project.
---

import { Download03Icon } from '@nxenv/styleguide-icons/outline/Download03Icon';
...
In this chapter, let's learn how to create a new Nxenv project and how to get it running.

<VideoBoxLink videoId="m1-bc53EGh8" title="Watch: Creating your first universal Nxenv app" />
...
- [Nxenv Go](https://nxenv.dev/go) installed on a physical device
...
- A macOS, Linux, or Windows (PowerShell and [WSL2](https://nxenv.fyi/wsl)) with a terminal window open
...
## Initialize a new Nxenv app

We'll use [`create-nxenv-app`](/more/create-nxenv/) to initialize a new Nxenv app. It is a command line tool to create a new React Native project. Run the following command in your terminal:

<Terminal
  cmd={[
    '# Create a project named StickerSmash',
    '$ npx create-nxenv-app@latest StickerSmash',
    '',
    '# Navigate to the project directory',
    '$ cd StickerSmash',
  ]}
  cmdCopy="npx create-nxenv-app@latest StickerSmash && cd StickerSmash"
/>

This command will create a new project directory named StickerSmash, using the [default](/more/create-nxenv/#--template) template. This template has essential boilerplate code and libraries needed to build our app, including Nxenv Router. We'll continue to add more libraries throughout this tutorial as needed.

<Collapsible summary="Benefits of using the default template">

- Creates a new React Native project with `nxenv` package installed
- Includes recommended tools such as Nxenv CLI
- Includes a tab navigator from Nxenv Router to provide a basic navigation system
...
2. Scan that QR code to open the app on the device. On Android, use the Nxenv Go > **Scan QR code** option. On iOS, use the default camera app.
...
<ProgressTracker
  ...
  name="GET_STARTED"
  summary="We've successfully created a new Nxenv project, used React Native core components, and are ready to develop our StickerSmash app."
