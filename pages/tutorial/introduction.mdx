---
title: 'Nxenv Tutorial: Introduction'
sidebar_title: Introduction
description: An introduction to a tutorial on how to build a universal app that runs on Android, iOS and the web using Nxenv.
---
...
We're about to embark on a journey of building universal apps. In this tutorial, we'll create an Nxenv app that runs on Android, iOS, and web; all with a single codebase. Let's get started!

## About this tutorial

The objective of this tutorial is to get started with Nxenv and become familiar with the Nxenv SDK. It'll cover the following topics:

- Create an app using the default template with TypeScript enabled
- Implement a two-screen bottom tabs layout with Nxenv Router
...
These topics provide a foundation to learn the fundamentals of building an Nxenv app. The tutorial is self-paced and can take up to two hours to complete.
...
> **info** The complete source code for this tutorial is available on [GitHub](https://github.com/nxenv/examples/tree/master/stickersmash).
...
<BoxLink
  title="Start"
  Icon={BookOpen02Icon}
  description="Let's start by creating a new Nxenv app."
