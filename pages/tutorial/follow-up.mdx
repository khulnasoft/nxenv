...
description: Explore a curated list of resources to learn about Nxenv and React Native.
---
...
- [Get started at nxenv.new](https://nxenv.new/) which automatically configures a project with file-based routing and the required setup for EAS Build and EAS Update.
- Or, start locally on your machine and use `npx create-nxenv-app@latest` and [set up your development environment](/get-started/set-up-your-environment/) sequentially.
...
- [Development tools](/develop/tools/): A reference of Nxenv tools that will help you during various aspects of your app-building journey.
...
- [Development overview](/workflow/overview/): This is a high-level overview that provides details on key concepts for developing an app with Nxenv and the flow of core development loop.
- [Nxenv Router](/router/introduction/): We went through basics of Nxenv Router and implemented a tab navigator. See its documentation to learn more about the library.
...
We used React components and APIs. Having a solid understanding of React is essential to using Nxenv to build your app. We recommend reading the React documentation's [Quick Start section](https://react.dev/learn) and the [Hooks section](https://react.dev/reference/react/hooks).
...
Join our community on <A href="https://chat.nxenv.dev/" shouldLeakReferrer>Discord</A> to chat with other Nxenv users or to ask questions.
