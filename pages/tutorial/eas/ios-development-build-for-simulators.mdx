...
After responding to the prompts, our EAS Build is queued, and the EAS CLI provides a link to view build details and track progress on the Nxenv dashboard:
...
You can use [Nxenv Orbit] to install the development build. From **Build artifact** on the Nxenv dashboard, click **Open with Nxenv Orbit** to install the development build on the iOS Simulator.
