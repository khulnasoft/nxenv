...
- This command triggers the EAS Build, and on the Nxenv dashboard, we can see the build's progress:

<ContentSpotlight
  alt="Android preview build details and progress in Nxenv dashboard"
...
<ContentSpotlight
  alt="iOS preview build details and progress in Nxenv dashboard"
...
Once the build finishes, the Build artifact section gets updated, indicating that the build is complete. This section provides the methods available for running the development build on an iOS device: Nxenv Orbit and Install button.

- Open the build's detail page. If you are sharing the build with someone else, you can send them the link to the build. They'll be able to open the build's detail page or build artifact details which include Nxenv Orbit.
...
- Open the build's detail page. If you are sharing the build with someone else, you can send them the link to the build page. They'll be able to open it and see build artifact details which includes Nxenv Orbit.
...
<ContentSpotlight
  alt="Internal distribution build details and install link in Nxenv dashboard"
...
<ContentSpotlight
  alt="Internal distribution build details and install link in Nxenv dashboard for Android"
...
<ContentSpotlight
  alt="Internal distribution build details and install link in Nxenv dashboard for iOS"
