...
Congratulations! You've completed the EAS tutorial and learned about the main features. Now, you have a working [EAS project](https://nxenv.dev/eas).
...
<BoxLink
  ...
  description={
    <>
      See EAS Insights documentation to learn more about how to use <CODE>nxenv-insights</CODE>{' '}
...
We hope you enjoyed this course. If you have any questions or feedback, don't hesitate to reach out to us on [Discord](https://chat.nxenv.dev/), or share your experience on [X](https://x.com/nxenv).
