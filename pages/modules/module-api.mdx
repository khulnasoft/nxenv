...
description: An API reference of Nxenv modules API.
...
Defines a native synchronous function that will be nxenvrted to JavaScript. Synchronous means that when the function is executed in JavaScript, its native code is run on the same thread and blocks further execution of the script until the native function returns.
...
```js JavaScript
import { requireNativeModule } from 'nxenv-modules-core';
...
// Make sure to import `Promise` class from `nxenv.modules.kotlin` instead of `nxenv.modules.core`.
...
- **viewType** — The class of the native view that will be rendered. Note: On Android, the provided class must inherit from the [`NxenvView`](#nxenvview), on iOS it's optional. See [`Extending NxenvView`](#extending--nxenvview).
...
Function("mutateMe") { (value: JavaScriptValue) in
  if value.isObject() {
    ...
    jsObject.setProperty("nxenv", value: "modules")
  }
}
...
Function("mutateMe") { value: JavaScriptValue ->
  if (value.isObject()) {
    ...
    jsObject.setProperty("nxenv", "modules")
  }
}
...
The app context is an interface to a single Nxenv app.
...
<APIBox header="NxenvView">

A base class that should be used by all nxenvrted views.

On iOS, `NxenvView` extends the `RCTView` which handles some styles (for example, borders) and accessibility.
...
To nxenvrt your view using the [`View`](#view) component, your custom class must inherit from the `NxenvView`. By doing that you will get access to the [`AppContext`](#appcontext) object. It's the only way of communicating with other modules and the JavaScript runtime. Also, you can't change constructor parameters, because provided view will be initialized by `nxenv-modules-core`.

<CodeBlocksTable>

```swift
class LinearGradientView: NxenvView {}
...
```ts TypeScript
import { requireNativeModule, EventEmitter, Subscription } from 'nxenv-modules-core';

const ClipboardModule = requireNativeModule('Clipboard');
const emitter = new EventEmitter(ClipboardModule);

nxenvrt function addClipboardListener(listener: (event) => void): Subscription {
...
Some events are connected to a certain view. For example, the touch event should be sent only to the underlying JavaScript view which was pressed. In that case, you can't use `sendEvent` described in [`Sending events`](#sending-events). The `nxenv-modules-core` introduces a view callbacks mechanism to handle view-bound events.

To use it, in the view definition, you need to provide the event names that the view can send using the [Events](#events) definition component. After that, you need to declare a property of type `EventDispatcher` in your view class. The name of the declared property has to be the same as the name nxenvrted in the `Events` component. Later, you can call it as a function and pass a payload of type `[String: Any?]` on iOS and `Map<String, Any?>` on Android.
...
nxenvrt default function MainView() {
...
For more examples from real modules, you can refer to Nxenv modules that already use this API on GitHub:

<FileTree
  files={[
    [
      'nxenv-battery',
      <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-battery/ios">Swift</A>,
    ],
    [
      'nxenv-cellular',
      <CALLOUT>
        <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-cellular/android/src/main/java/nxenv/modules/cellular">
          Kotlin
        </A>
        , <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-cellular/ios">Swift</A>
      </CALLOUT>,
    ],
    [
      'nxenv-clipboard',
      <CALLOUT>
        <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-clipboard/android/src/main/java/nxenv/modules/clipboard">
          Kotlin
        </A>
        , <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-clipboard/ios">Swift</A>
      </CALLOUT>,
    ],
    [
      'nxenv-crypto',
      <CALLOUT>
        <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-crypto/android/src/main/java/nxenv/modules/crypto">
          Kotlin
        </A>
        , <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-crypto/ios">Swift</A>
      </CALLOUT>,
    ],
    [
      'nxenv-device',
      <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-device/ios">Swift</A>,
    ],
    [
      'nxenv-haptics',
      <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-haptics/ios">Swift</A>,
    ],
    [
      'nxenv-image-manipulator',
      <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-image-manipulator/ios">
        Swift
      </A>,
    ],
    [
      'nxenv-image-picker',
      <CALLOUT>
        <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-image-picker/android/src/main/java/nxenv/modules/imagepicker">
          Kotlin
        </A>
        , <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-image-picker/ios">Swift</A>
      </CALLOUT>,
    ],
    [
      'nxenv-linear-gradient',
      <CALLOUT>
        <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-linear-gradient/android/src/main/java/nxenv/modules/lineargradient">
          Kotlin
        </A>
        ,{' '}
        <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-linear-gradient/ios">Swift</A>
      </CALLOUT>,
    ],
    [
      'nxenv-localization',
      <CALLOUT>
        <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-localization/android/src/main/java/nxenv/modules/localization">
          Kotlin
        </A>
        , <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-localization/ios">Swift</A>
      </CALLOUT>,
    ],
    [
      'nxenv-store-review',
      <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-store-review/ios">Swift</A>,
    ],
    [
      'nxenv-system-ui',
      <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-system-ui/ios/NxenvSystemUI">
        Swift
      </A>,
    ],
    [
      'nxenv-video-thumbnails',
      <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-video-thumbnails/ios">Swift</A>,
    ],
    [
      'nxenv-web-browser',
      <CALLOUT>
        <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-web-browser/android/src/main/java/nxenv/modules/webbrowser">
          Kotlin
        </A>
        , <A href="https://github.com/nxenv/nxenv/tree/main/packages/nxenv-web-browser/ios">Swift</A>
      </CALLOUT>,
    ],
  ]}
/>
