...
description: Learn about the mechanism that allows your library to hook into Android Activity and Application functions using Nxenv modules API.
---
...
The React Native module API does not provide any mechanism to hook into these, and so setup instructions for React Native libraries often include steps to copy code into these files. To simplify and automate setup and maintenance, the Nxenv Modules API provides a mechanism that allows your library to hook into `Activity` or `Application` functions.

## Get started

First, you need to have created an Nxenv module or integrated the Nxenv modules API in the library using the React Native module API. [Learn more](./overview.mdx#setup).

Inside your module, create a concrete class that implements the [`Package`](https://github.com/nxenv/nxenv/tree/main/packages/nxenv-modules-core/android/src/main/java/nxenv/modules/core/interfaces/Package.java) interface. For most cases, you only need to implement the `createReactActivityLifecycleListeners` or `createApplicationLifecycleListeners` methods.
...
```kotlin
// android/src/main/java/nxenv/modules/mylib/MyLibPackage.kt
package nxenv.modules.mylib

import android.content.Context
import nxenv.modules.core.interfaces.Package
...
```java
// android/src/main/java/nxenv/modules/mylib/MyLibPackage.java
package nxenv.modules.mylib;
...
```kotlin
// android/src/main/java/nxenv/modules/mylib/MyLibReactActivityLifecycleListener.kt
package nxenv.modules.mylib
...
```java
// android/src/main/java/nxenv/modules/mylib/MyLibReactActivityLifecycleListener.java
package nxenv.modules.mylib;
...
import android.content.Context
import nxenv.modules.core.interfaces.ApplicationLifecycleListener
import nxenv.modules.core.interfaces.Package
...
```kotlin
// android/src/main/java/nxenv/modules/mylib/MyLibApplicationLifecycleListener.kt
package nxenv.modules.mylib
...
```java
// android/src/main/java/nxenv/modules/mylib/MyLibApplicationLifecycleListener.java
package nxenv.modules.mylib;
