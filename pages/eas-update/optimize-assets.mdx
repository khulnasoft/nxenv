...
When publishing an update, EAS CLI runs Nxenv CLI to bundle the project into an update. The update will appear in our project's **./dist** directory.
...
To manually optimize image assets in your project, you can use the `npx nxenv-optimize` command. It uses [sharp](https://sharp.pixelplumbing.com/) library to compress images.

<Terminal cmd={['$ npx nxenv-optimize']} />
...
<Terminal cmd={['$ npx nxenv-optimize --quality 90']} />
