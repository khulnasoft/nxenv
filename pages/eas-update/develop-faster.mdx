...
- A [development build](/eas-update/nxenv-dev-client/) with a matching runtime version, distributed through [internal distribution](/build/internal-distribution/) or as an emulator or simulator build.
...
- Nxenv Go can also load published updates in cases where custom native code is not used.
