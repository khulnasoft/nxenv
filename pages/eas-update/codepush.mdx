...
<Step label="2">
## Add an `nxenv` key to your `app.json`

Ensure that your project has an **app.json** file with an `nxenv` object. If you don't have anything specific to configure in your **app.json** file yet, you can create a minimal file with an empty `nxenv` object like this:
