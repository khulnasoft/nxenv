...
description: Make your first change to an Nxenv project and see it live on your device.
hideTOC: true
---
...
@@ -17,7 +17,7 @@ nxenvrt default function HomeScreen() {
       }
     >
...
Nxenv Go is configured by default to automatically reload the app whenever a file is changed, but let's make sure to go over the steps to enable it in case somehow things aren't working.

- Make sure you have the [development mode enabled in Nxenv CLI](/workflow/development-mode#development-mode).
- Close the Nxenv app and reopen it.
...
- If you see **Enable Fast Refresh**, press it. If you see **Disable Fast Refresh**, dismiss the developer menu. Now try making another change.
  ...
  <ContentSpotlight
    alt="Developer menu in Nxenv Go app."
