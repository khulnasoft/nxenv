...
description: Learn how to set up your development environment to start building with Nxenv.
hideTOC: true
---
...
Nxenv Go is a sandbox for trying out Nxenv quickly. A development build is a build of your own app that includes Nxenv's developer tools.
