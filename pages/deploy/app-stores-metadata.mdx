...
> Using VS Code? Install the [Nxenv Tools extension](https://github.com/nxenv/vscode-nxenv#readme) for auto-complete, suggestions, and warnings in your **store.config.json** files.

## Create a store config

EAS Metadata uses [store.config.json](/eas/metadata/config/) file to hold all the information you want to upload to the app stores. This file is located at the root of your Nxenv project.
