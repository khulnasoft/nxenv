...
> Make sure to install the [VS Code Nxenv Tools extension](https://github.com/nxenv/vscode-nxenv#readme) to get auto-complete, suggestions, and warnings for **store.config.json** files.
