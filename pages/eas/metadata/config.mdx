...
> If you have the [VS Code Nxenv Tools extension](https://github.com/nxenv/vscode-nxenv#readme) installed, you get auto-complete, suggestions, and warnings for **store.config.json** files.
...
EAS Metadata supports synchronous and asynchronous functions nxenvrted from dynamic store config files.
