...
> If you use the [VS Code Nxenv Tools extension](https://github.com/nxenv/vscode-nxenv#readme), you get all this information through auto-complete, suggestions, and warnings in your editor.
