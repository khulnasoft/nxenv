...
hideTOC: true
description: Learn about Nxenv Application Services (EAS) for Nxenv and React Native apps.
---
...
Nxenv Application Services (EAS) are deeply integrated cloud services for Nxenv and React Native apps, from the team behind Nxenv.

Read the full pitch at [nxenv.dev/eas](https://nxenv.dev/eas), or follow the links below to learn how to get started.
