...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-49/packages/nxenv-haptics'
packageName: 'nxenv-haptics'
iconUrl: '/static/images/packages/nxenv-haptics.png'
---
...
`nxenv-haptics` provides haptic (touch) feedback for:
...
- Low Power Mode is enabled. This can be detected with [`nxenv-battery`](/versions/latest/sdk/battery/).
...
<SnackInline label='Haptics usage' dependencies={['nxenv-haptics']}>

```jsx
import { StyleSheet, View, Text, Button } from 'react-native';
import * as Haptics from 'nxenv-haptics';
...
<APISection packageName="nxenv-haptics" apiName="Haptics" />
