...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-49/packages/nxenv-network'
packageName: 'nxenv-network'
iconUrl: '/static/images/packages/nxenv-network.png'
---
...
`nxenv-network` provides useful information about the device's network such as its IP address, MAC address, and airplane mode status.
...
```js
import * as Network from 'nxenv-network';
```

<APISection packageName="nxenv-network" apiName="Network" />
