...
> **Additional setup required for web**: If you want to use Skia on web, you will need to follow [web installation instructions](https://shopify.github.io/react-native-skia/docs/getting-started/web/#nxenv) to load CanvasKit.
