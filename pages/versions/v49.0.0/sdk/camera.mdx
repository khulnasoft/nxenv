...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-49/packages/nxenv-camera'
...
```jsx
import { Camera, CameraType } from 'nxenv-camera';
...
<APISection packageName="nxenv-camera" apiName="Camera" />
