...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-49/packages/nxenv-application'
packageName: 'nxenv-application'
---
...
`nxenv-application` provides useful information about the native application, itself, such as the ID, app name, and build version.
...
```js
import * as Application from 'nxenv-application';
```

<APISection packageName="nxenv-application" apiName="Application" />
