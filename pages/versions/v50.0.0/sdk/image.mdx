...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-50/packages/nxenv-image'
packageName: 'nxenv-image'
iconUrl: '/static/images/packages/nxenv-image.png'
---
...
`nxenv-image` is a cross-platform React component that loads and renders images.
...
<APISection packageName="nxenv-image" apiName="Image" />
