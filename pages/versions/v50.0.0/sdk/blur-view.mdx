...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-50/packages/nxenv-blur'
packageName: 'nxenv-blur'
iconUrl: '/static/images/packages/nxenv-blur.png'
---
...
<SnackInline label='Basic BlurView usage' dependencies={['nxenv-blur']}>

```jsx
import { Text, StyleSheet, View, SafeAreaView } from 'react-native';
import { BlurView } from 'nxenv-blur';
...
<APISection packageName="nxenv-blur" />
