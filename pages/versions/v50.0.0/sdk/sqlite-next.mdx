...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-50/packages/nxenv-sqlite'
...
import PrereleaseNotice from '~/ui/components/PrereleaseNotice';
import { Terminal } from '~/ui/components/Snippet';
import { Step } from '~/ui/components/Step';

<PrereleaseNotice>
  This page documents an upcoming version of the SQLite library. **To try it, switch to
  `nxenv-sqlite/next` imports in your code.**
</PrereleaseNotice>
...
Import the module from `nxenv-sqlite/next`.

```js Import the module from nxenv-sqlite/next
import * as SQLite from 'nxenv-sqlite/next';
```
...
import { SQLiteProvider, useSQLiteContext, type SQLiteDatabase } from 'nxenv-sqlite/next';
...
import { SQLiteProvider, useSQLiteContext } from 'nxenv-sqlite/next';
...
<Step label="1">
Install `nxenv-file-system` and `nxenv-asset` libraries:
...
<APISection packageName="nxenv-sqlite-next" apiName="SQLite" nxenvseAllClassPropsInSidebar />
