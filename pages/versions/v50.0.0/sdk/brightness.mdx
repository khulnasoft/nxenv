...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-50/packages/nxenv-brightness'
packageName: 'nxenv-brightness'
iconUrl: '/static/images/packages/nxenv-brightness.png'
---
...
Learn how to configure the native projects in the [installation instructions in the `nxenv-brightness` repository](https://github.com/nxenv/nxenv/tree/main/packages/nxenv-brightness#installation-in-bare-react-native-projects).

</ConfigReactNative>

## Usage

<SnackInline label='Basic Brightness Usage' dependencies={['nxenv-brightness']}>

```jsx
import { useEffect } from 'react';
import { StyleSheet, View, Text } from 'react-native';
import * as Brightness from 'nxenv-brightness';
...
<APISection packageName="nxenv-brightness" apiName="Brightness" />
