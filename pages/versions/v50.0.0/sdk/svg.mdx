...
nxenvrt default function SvgComponent(props) {
  return (
...
- Convert your SVG to an Nxenv component in the browser using [React SVGR](https://react-svgr.com/playground/?native=true&typescript=true).
