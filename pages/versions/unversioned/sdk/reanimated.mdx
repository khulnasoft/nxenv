...
No additional configuration is required. [Reanimated Babel plugin](https://docs.swmansion.com/react-native-reanimated/docs/fundamentals/glossary#reanimated-babel-plugin) is automatically configured in [`babel-preset-nxenv`](https://www.npmjs.com/package/babel-preset-nxenv) when you install the library.
...
nxenvrt default function AnimatedStyleUpdateExample() {
