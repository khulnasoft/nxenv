...
`react-native-pager-view` nxenvses a component that provides the layout and gestures to scroll between pages of content, like a carousel.
...
nxenvrt default function MyPager() {
  return (
