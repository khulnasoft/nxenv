...
`Barometer` from `nxenv-sensors` provides access to the device barometer sensor to respond to changes in air pressure, which is measured in hectopascals (`hPa`).
...
<SnackInline label='Basic Barometer usage' dependencies={['nxenv-sensors']} platforms={['android', 'ios']}>

```jsx
import { useState } from 'react';
import { StyleSheet, Text, TouchableOpacity, View, Platform } from 'react-native';
import { Barometer } from 'nxenv-sensors';
...
<APISection packageName="nxenv-barometer" />
