...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-51/packages/nxenv-dev-client'
...
<ConfigPluginProperties
  properties={[
    ...
    },
    {
      ...
      description: [
        'By default, `nxenv-dev-client` will register a custom URL scheme to open a project. Set this property to `false` to disable this scheme.',
      ].join('\n'),
      default: 'true',
    },
  ]}
...
```js
import { DevLauncher, DevMenu } from 'nxenv-dev-client';
```

<APISection packageName={['nxenv-dev-menu']} apiName="DevMenu" />
<APISection packageName={['nxenv-dev-launcher']} apiName="DevLauncher" />
