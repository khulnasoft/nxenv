...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-51/packages/nxenv-print'
packageName: 'nxenv-print'
iconUrl: '/static/images/packages/nxenv-print.png'
...
`nxenv-print` provides an API for Android and iOS (AirPrint) printing functionality.
...
<SnackInline label='Print usage' dependencies={['nxenv-print', 'nxenv-sharing']}>

```jsx
import { useState } from 'react';
import { View, StyleSheet, Button, Platform, Text } from 'react-native';
import * as Print from 'nxenv-print';
import { shareAsync } from 'nxenv-sharing';
...
<APISection packageName="nxenv-print" apiName="Print" />
...
import { printAsync } from 'nxenv-print';
import { manipulateAsync } from 'nxenv-image-manipulator';
