...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-51/packages/nxenv-location'
...
<SnackInline label='Location' dependencies={['nxenv-location', 'nxenv-constants']}>
...
> **Note**: Foreground and background services are not available in Nxenv Go for Android.
