...
description: A library that allows scanning a variety of supported barcodes. It is available both as a standalone library and as an extension for Nxenv Camera.
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-51/packages/nxenv-barcode-scanner'
packageName: 'nxenv-barcode-scanner'
iconUrl: '/static/images/packages/nxenv-barcode-scanner.png'
...
> **warning** **Deprecated:** This library will no longer be available from SDK 51. We recommend using [`nxenv-camera`](camera) which has barcode scanning built-in instead.

`nxenv-barcode-scanner` provides a React component that renders a viewfinder for the device's camera (either front or back) and will scan bar codes that show up in the frame.
...
Learn how to configure the native projects in the [installation instructions in the `nxenv-barcode-scanner` repository](https://github.com/nxenv/nxenv/tree/main/packages/nxenv-barcode-scanner#installation-in-bare-react-native-projects).
...
<SnackInline label="Basic BarCodeScanner usage" dependencies={['nxenv-barcode-scanner']}>

```jsx
import { useState, useEffect } from 'react';
import { Text, View, StyleSheet, Button } from 'react-native';
import { BarCodeScanner } from 'nxenv-barcode-scanner';
...
<APISection packageName="nxenv-barcode-scanner" apiName="BarCodeScanner" />
