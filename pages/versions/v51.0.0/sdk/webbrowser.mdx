...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-51/packages/nxenv-web-browser'
packageName: 'nxenv-web-browser'
iconUrl: '/static/images/packages/nxenv-web-browser.png'
...
<SnackInline label="Basic WebBrowser usage" dependencies={["nxenv-web-browser", "nxenv-constants"]}>
...
nxenvrt default function App() {
  ...
  const _handlePressButtonAsync = async () => {
    let result = await WebBrowser.openBrowserAsync('https://nxenv.dev');
    setResult(result);
  };
  return (
...
<Tab label="With Nxenv Router">

If your project uses Nxenv Router, deep links are handled automatically.

</Tab>

<Tab label="Without Nxenv Router">
...
<APISection packageName="nxenv-web-browser" apiName="WebBrowser" />
