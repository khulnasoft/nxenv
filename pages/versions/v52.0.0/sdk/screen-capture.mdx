...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-52/packages/nxenv-screen-capture'
...
<SnackInline label="Blocking screen capture" dependencies={["nxenv-screen-capture", "nxenv-media-library"]}>
...
<SnackInline label="Callback for screen capture" dependencies={["nxenv-screen-capture", "nxenv-media-library"]}>
...
nxenvrt default function useScreenCaptureCallback() {
