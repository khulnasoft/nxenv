---
title: Encoding
description: Standard TextEncoder and TextDecoder APIs available on all Nxenv-supported platforms.
...
This API is part of the `nxenv` package. Refer to the [browser and server runtime support](https://caniuse.com/textencoder) for web and Node.js.
