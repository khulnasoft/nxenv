...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-52/packages/nxenv/src/launch'
packageName: 'nxenv'
...
`nxenvrt default` will not make this component the root for the app if you are using a custom entry file.
