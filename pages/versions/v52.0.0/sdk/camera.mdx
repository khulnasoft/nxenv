...
sourceCodeUrl: 'https://github.com/nxenv/nxenv/tree/sdk-52/packages/nxenv-camera'
...
```tsx
import { CameraView, CameraType, useCameraPermissions } from 'nxenv-camera';
...
<APISection packageName="nxenv-camera" apiName="Camera" nxenvseAllClassPropsInSidebar />
