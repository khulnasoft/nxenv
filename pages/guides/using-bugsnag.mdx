...
See the integration guide below for instructions on adding BugSnag to your Nxenv apps to report JavaScript errors. It also includes instructions for uploading source maps for updates published with [EAS Update](/eas-update/introduction/).
...
<BoxLink
  title="Nxenv BugSnag integration"
  description="See the official guide on how to integrate BugSnag with an Nxenv app."
  href="https://docs.bugsnag.com/platforms/react-native/nxenv/"
  Icon={BookOpen02Icon}
/>
