...
import { FigmaIcon } from '@nxenv/styleguide-icons/outline/FigmaIcon';
...
<ContentSpotlight
  alt="Screenshots of the Nxenv Go Apple App Store Listing Page"
  caption="Screenshots of the Nxenv Go Apple App Store Listing Page."
  src="/static/images/guides/nxenv-go-screenshots.png"
