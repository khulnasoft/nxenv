...
description: A guide on using react-native-fbsdk-next library to integrate Facebook authentication in your Nxenv project.
---

import { BoxLink } from '~/ui/components/BoxLink';
import { ContentSpotlight } from '~/ui/components/ContentSpotlight';

The [`react-native-fbsdk-next`](https://github.com/thebergamo/react-native-fbsdk-next/) library provides a wrapper around Facebook's Android and iOS SDKs. It allows integrating Facebook authentication into your Nxenv project and provide access to native components.

This guide provides additional information on configuring the library with Nxenv for Android.

## Prerequisites

The `react-native-fbsdk-next` library can't be used in the Nxenv Go app because it requires custom native code. Learn more about [adding custom native code to your app](/workflow/customizing/).
...
<BoxLink
  title="React Native FBSDK Next: Nxenv installation instructions"
  href="https://github.com/thebergamo/react-native-fbsdk-next/#nxenv-installation"
/>
