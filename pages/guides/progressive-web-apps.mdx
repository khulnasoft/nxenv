...
description: Learn how to add progressive web app support to Nxenv websites.
---
...
Nxenv CLI automatically generates the **favicon.ico** file based on the `web.favicon` field in the **app.json**.
...
<Terminal
  cmd={['$ npx nxenv customize public/index.html']}
  cmdCopy="npx nxenv customize public/index.html"
/>
