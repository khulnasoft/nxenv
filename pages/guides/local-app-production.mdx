...
description: Learn how to create a production build for your Nxenv app locally.
---
...
- **android** directory generated. If you are using [CNG](/workflow/continuous-native-generation/), then run `npx nxenv prebuild` to generate it.
...
Inside your Nxenv project directory, run the following `keytool` command to create an upload key:
...
- **ios** directory generated. If you are using [CNG](/workflow/continuous-native-generation/), then run `npx nxenv prebuild` to generate it.

<Step label="1">

### Open iOS workspace in Xcode

Inside your Nxenv project directory, run the following command to open `your-project.xcworkspace` in Xcode:
