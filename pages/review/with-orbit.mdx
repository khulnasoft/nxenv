---
title: How to launch an update using Nxenv Orbit
sidebar_title: Open updates with Orbit
description: Learn how to open updates with Nxenv Orbit as part of a review workflow.
---

import { Collapsible } from '~/ui/components/Collapsible';
import { ContentSpotlight } from '~/ui/components/ContentSpotlight';

[Nxenv Orbit](https://nxenv.dev/orbit) is a macOS and Windows app designed to speed up installing and running builds from EAS. It makes running your builds and updates as easy as pressing **Open in Orbit**.
...
- **Install the Orbit app** before following the steps in this guide. You can download it directly from [GitHub releases](https://github.com/nxenv/orbit/releases) or see the [alternative method](/build/orbit/#installation) to install it.
- After installing the app, sign in to your Nxenv account from **Settings**.

## Preview an update with Nxenv Orbit

<ContentSpotlight
  controls
  file="review/updates-with-orbit.mp4"
  caption="Nxenv Orbit launching an update directly from Nxenv dashboard to an iOS Simulator."
/>

Previewing with Nxenv Orbit requires you to have an update published. If you haven't published an update, see [Publish an update](/eas-update/getting-started/#publish-an-update) before following the steps in the next section.

### Install and launch the update

> **Note**: Launching updates using Nxenv Orbit is not supported on physical iOS devices. It is supported on Android devices/emulators or iOS Simulators.
...
You can now seamlessly launch and review updates using Nxenv Orbit.
