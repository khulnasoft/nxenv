...
<Terminal
  cmd={[
    ...
    '',
    '...',
    'EAS Dashboard      https://nxenv.dev/accounts/your-account/projects/your-project/updates/708b05d8-9bcf-4212-a052-ce40583b04fd',
  ]}
/>
...
<ContentSpotlight
  alt="Preview update QR code UI on nxenv.dev."
