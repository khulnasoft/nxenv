...
[Nxenv Application Services (EAS)](/eas/) offers [free access](https://nxenv.dev/eas/fair-use#commercial-usage) to a limited quantity of low-priority builds on [EAS Build](/build/introduction/) and free updates with [EAS Update](/eas-update/introduction/). These limits reset monthly.
...
Subscriptions are billed monthly and are priced the same worldwide (pre-tax). To see your account's current subscribed plan, go to [your account's Billing](https://nxenv.dev/settings/billing), and under **Plan**, you will find details of your current plan.
...
We also offer annual contracts on an as-needed basis. Contact our [customer support](https://nxenv.dev/contact) team to see if an annual plan suits you.
...
Usage-based billing is billed monthly and is currently enabled for EAS Build and EAS Update. We provide an estimate of your existing usage and any overage charges on [your account's Billing](https://nxenv.dev/settings/billing).
...
<BoxLink
  ...
  href="https://nxenv.dev/eas/enterprise-support"
  Icon={CreditCard02Icon}
/>
