...
This page covers frequently asked questions about plans, billing, and payment for [Nxenv Application Services (EAS)](/eas/).
...
- From the Nxenv dashboard's navigation menu, under **Account**, switch to the account from which you intend to subscribe.
- Go to [Billing](https://nxenv.dev/settings/billing) and under **Plan**, [follow the steps to subscribe to the right plan](/billing/manage/#upgrade-to-a-new-plan).
- From the wrong account, go to **[Receipts](https://nxenv.dev/accounts/[account]/settings/receipts)** and initiate a [request for a refund](/billing/invoices-and-receipts/#request-a-refund).
...
- Go to your [account's Billing](https://nxenv.dev/settings/billing), and click on **Update billing information**. This will take you to Stripe's portal.
...
Annual plans are available for [Enterprise plan](/billing/plans/#enterprise) customers. [Contact us](https://nxenv.dev/contact) for more information.
...
[Enterprise plan](/billing/plans/#enterprise) customers on annual plans can pay by ACH as an alternative to credit card payments. [Contact us](https://nxenv.dev/contact) for more information.

### I need a W-9, or other legal documentation

To request a W-9, [contact us](https://nxenv.dev/contact).

Find our legal terms at [nxenv.dev/terms](https://nxenv.dev/terms).

### Does Nxenv store my card information?

No, Nxenv does not. We use Stripe to handle the payment system and they do. See [how Stripe handles security](https://docs.stripe.com/security) for more information.

### How much did I pay for a large build this month?

To view the cost of a large build, go to [Billing](https://nxenv.dev/settings/billing). Under **Usage this month** you will find a summary of your EAS Build usage based on the [resource class](/build/eas-json/#selecting-resource-class) and the amount spent.

## Add-ons

### How do I increase build concurrencies on my account?

If you're already subscribed to a paid EAS plan, you can buy additional concurrencies in the [**Add-ons** section](https://nxenv.dev/settings/billing) under **Billing**.

If you're on the Free plan, you'll need to set up a paid subscription. [Click here](https://nxenv.dev/accounts/[account]/settings/billing/cart) to choose a new plan. Then, select the number of additional concurrencies to add to your subscription on the checkout page.

Each plan has different number of concurrencies included. If you need more than 5 additional concurrencies, [contact us](https://nxenv.dev/contact).
