---
title: Trigger builds from the Nxenv GitHub App
sidebar_title: Trigger builds from GitHub App
description: Learn how to trigger builds on EAS for your app using the Nxenv GitHub App.
---

import { ContentSpotlight } from '~/ui/components/ContentSpotlight';

This guide explains how to trigger builds directly from your GitHub repository using the Nxenv GitHub App.
...
- An Nxenv user in the organization must have a linked GitHub user with access to the target repository. Check [User settings > Connections](https://nxenv.dev/settings#connections) and verify that your GitHub user account is linked.
- You must accept the permissions requested by the [Nxenv GitHub app](https://github.com/settings/installations).

## Configure your app for GitHub

### Link your GitHub repository to your Nxenv project

Visit your project's [GitHub settings](https://nxenv.dev/accounts/[account]/projects/[projectName]/github).
...
Install the Nxenv GitHub App on your GitHub account.

> **Note:** You must have [Owner or Admin access](/accounts/account-types/#manage-access) of the Nxenv account to install the app.
...
Then, link the GitHub repository to your Nxenv project.

> **Note:** You can only link [GitHub organization repositories](https://docs.github.com/en/organizations) to Nxenv organizations.

<ContentSpotlight
  alt="The repository selector on the Nxenv project GitHub settings page"
...
<ContentSpotlight
  alt="The account selector on the Nxenv project GitHub settings page"
...
Before you run a build, the Nxenv GitHub App needs to know where to find the source code for your project. If your Nxenv
project source code is in the root of your repository, then you don't need to do anything. If your
Nxenv project source code is in a subdirectory, then you'll need to configure "Base directory"
settings for your repository on your project's [GitHub settings
page](https://nxenv.dev/accounts/[account]/projects/[projectName]/github).

<ContentSpotlight
  alt="The base directory input on the Nxenv project GitHub settings page"
...
### Build using the Nxenv website

Visit your project's [build list
page](https://nxenv.dev/accounts/[account]/projects/[projectName]/builds) and click the "Build from
...
<ContentSpotlight
  alt="The build from GitHub UI on the Nxenv project builds list page"
...
You can take your build automation further by automatically building your Nxenv project when you push code to GitHub.
...
Open your Nxenv project in the dashboard. To create a build trigger, scroll down to the **Build
triggers** section of the project GitHub settings page and click **New Build Trigger**.

<ContentSpotlight
  alt="The build triggers section on the Nxenv project GitHub settings page"
...
<ContentSpotlight
  alt="The build triggers section on the Nxenv project GitHub settings page filled with build triggers"
...
On your project's GitHub settings page in the Nxenv dashboard, you can click the options button to the right of
...
- Navigate to your project's GitHub settings page on the Nxenv dashboard.
