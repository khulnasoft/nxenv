...
description: Learn how to stack overlapping views with zIndex in Nxenv and React Native apps.
---
...
`zIndex` is the Nxenv and React Native analog of [CSS's `z-index` property](https://developer.mozilla.org/en-US/docs/Web/CSS/z-index) which lets the developer control the order in which components are displayed over one another.
...
<ContentSpotlight
  ...
  alt="Three square components in a square parent container"
  src="/static/images/z-index/default-layout.png"
/>
...
<SnackEmbed platform="web" preview name="Intersecting views">
  {`
import React from "react";
import { StyleSheet, View } from "react-native";\n
nxenvrt default function App() {
...
<ContentSpotlight
  className="max-w-[360px]"
  alt="Three square components intersecting each other"
  src="/static/images/z-index/default-visually-stacked.png"
/>
...
<ContentSpotlight
  className="max-w-[360px]"
  alt="Three components where the second is stacked above the first and third"
  src="/static/images/z-index/relative-z-index.png"
/>
...
<ContentSpotlight
  className="max-w-[360px]"
  alt="Position absolute example"
  src="/static/images/z-index/absolute-position.png"
/>
...
<ContentSpotlight
  className="max-w-[360px]"
  alt="Position absolute component out of visual bounds of parent"
  src="/static/images/z-index/absolute-z-index-bounds.png"
/>
...
<ContentSpotlight
  className="max-w-[360px]"
  alt="Position absolute child must respect parent's zIndex"
  src="/static/images/z-index/z-index-parent.png"
/>
