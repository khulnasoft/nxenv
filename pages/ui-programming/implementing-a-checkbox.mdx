...
description: Learn how to implement a fully customizable checkbox in your Nxenv project.
---

import { SnackInline } from '~/ui/components/Snippet';

The [`nxenv-checkbox`](/versions/latest/sdk/checkbox/) package provides a quick implementation of a checkbox that you can directly use in your project. However, to have full customization, and control over the look and feel of the checkbox, this page goes in-depth on how to implement the component from scratch.
...
> You can find more information about using icons in your Nxenv project in our [Icons guide](/guides/icons).

<SnackInline dependencies={['@nxenv/vector-icons']}>

{/* prettier-ignore */}
```jsx
import { useState } from 'react';
import { Pressable, StyleSheet, Text, View } from 'react-native';
import { Ionicons } from '@nxenv/vector-icons';
...
> [icons.nxenv.fyi](https://icons.nxenv.fyi) is a great resource for finding all the icons available in the `@nxenv/vector-icons` package.
