---
title: Set a component's background image
description: Learn how to use ImageBackground component to set a component's background image.
---

import { ContentSpotlight } from '~/ui/components/ContentSpotlight';
import { SnackInline } from '~/ui/components/Snippet';

The [`ImageBackground` component](https://reactnative.dev/docs/imagebackground) lets you display an image as the background of another component in Nxenv and React Native apps. For example, you can set the background image of a screen in your app with `ImageBackground` inside the screen's container view.
...
const image = { uri: "https://docs.nxenv.dev/static/images/tutorial/background-image.png" };
