...
If you want to build an Android app binary you'll need to have a keystore. If you don't have a release keystore yet, you can generate it on your own using the following command (replace `KEYSTORE_PASSWORD`, `KEY_PASSWORD`, `KEY_ALIAS` and `com.nxenv.your.android.package` with the values of your choice):
...
<Terminal
  cmd={[
    ...
    '  -dname "CN=com.nxenv.your.android.package,OU=,O=,L=,S=,C=US"',
  ]}
  cmdCopy='keytool -genkey -v -storetype JKS -keyalg RSA -keysize 2048 -validity 10000 -storepass KEYSTORE_PASSWORD -keypass KEY_PASSWORD -alias KEY_ALIAS -keystore release.keystore -dname "CN=com.nxenv.your.android.package,OU=,O=,L=,S=,C=US"'
/>
