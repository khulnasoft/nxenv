...
The [`nxenv-notifications`](/versions/latest/sdk/notifications) library contains event listeners that handle how your app responds when receiving a notification.
    ...
    "trigger": {
      "remoteMessage": {
        ...
        "data": {
          ...
          "scopeKey": "@betoatnxenv/nxenv-notifications-app",
          "experienceId": "@betoatnxenv/nxenv-notifications-app",
          "projectId": "51092087-87a4-4b12-8008-145625477434"
        },
        "to": null,
        "ttl": 0,
        "collapseKey": "dev.nxenv.notificationsapp",
        "messageType": null,
        "priority": 2,
        "from": "115310547649",
