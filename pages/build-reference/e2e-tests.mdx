...
The example demonstrates how to configure your EAS Build Maestro E2E tests workflow using the [default Nxenv template](/more/create-nxenv/#--template). For your own app, you will need to adjust the flows to match your app's UI.

<Step label="1">
## Initialize a new project

You can skip this step if you already have an existing Nxenv project.
...
<Terminal
  cmd={[
    '# Initialize a new project',
    '$ npx create-nxenv-app@latest eas-tests-example',
    '',
    '# Move into the project directory',
    '$ cd eas-tests-example',
  ]}
  cmdCopy="npx create-nxenv-app eas-tests-example && cd eas-tests-example"
/>
</Step>
...
The following command creates a new project on Nxenv servers for your app and creates [**eas.json**](/build/eas-json/) in the project's root directory:
...
Go to [**Project settings**](https://nxenv.dev/accounts/[account]/projects/[project]/settings) and disable **New Android Builds Infrastructure**.
...
This is what the UI of the app created from the default Nxenv template looks like:
...
appId: dev.nxenv.eastestsexample # This is an example app id. Replace it with your app id.
---
- launchApp
...
This is likely because the New Build Infrastructure is enabled for your project. Go to [**Project Settings**](https://nxenv.dev/accounts/[account]/projects/[project]/settings) and disable **New Android Builds Infrastructure**.
