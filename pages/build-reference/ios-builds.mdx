...
1. Create the tarball containing a copy of the repository. Actual behavior depends on the [VCS workflow](https://nxenv.fyi/eas-vcs-workflow) you are using.
...
1. Run `npx nxenv-doctor` to diagnose potential issues with your project configuration.
...
1. Additional step for **managed** projects: Run `npx nxenv prebuild` to convert the project to a bare one. This step will use the versioned Nxenv CLI.
...
nxenvrt_options({
  ...
  provisioningProfiles: {
    "com.nxenv.eas.builds.test.application" => "dd83ed9c-4f89-462e-b901-60ae7fe6d737"
  }
})

nxenvrt_xcargs "OTHER_CODE_SIGN_FLAGS=\"--keychain /tmp/path/to/keychain\""
