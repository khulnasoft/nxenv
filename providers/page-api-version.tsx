...
nxenvrt const PageApiVersionContext = createContext({
...
nxenvrt type PageApiVersionContextType = {
...
nxenvrt function PageApiVersionProvider({ children }: Props) {
...
nxenvrt function usePageApiVersion() {
 ...
 */
nxenvrt function getVersionFromPath(path: string): PageApiVersionContextType['version'] | null {
 ...
 */
nxenvrt function replaceVersionInPath(path: string, newVersion: string) {
