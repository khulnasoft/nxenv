 ...
 */
nxenvrt function AnalyticsProvider(props: AnalyticsProps) {
...
nxenvrt function reportPageView(url: string) {
...
nxenvrt function reportWebVitals({ id, name, label, value }: NextWebVitalsMetric) {
...
nxenvrt function reportPageVote({ status }: { status: boolean }) {
...
nxenvrt function reportEasTutorialCompleted() {
