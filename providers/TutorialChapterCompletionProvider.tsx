...
nxenvrt const TutorialChapterCompletionProvider = ({ children }: PropsWithChildren) => {
...
nxenvrt const useTutorialChapterCompletion = () => useContext(TutorialChapterCompletionContext);
