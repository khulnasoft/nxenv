...
nxenvrt function getRedirectPath(redirectPath: string): string {
  ...
  // the last path part
  // https://docs.nxenv.dev/versions/latest/sdk/overview/null
 ...
 *   - `/versions/<version>/sdk/**`, pages within the Nxenv SDK docs.
 *   - `/versions/<version>/react-native/**`, pages within the React Native API docs.
 *   - `/versions/<version>/`, the index of a specific Nxenv SDK version.
 * All other paths shouldn't require versioning, some of them are:
 *   - `/versions/<version>/workflow/nxenv-cli/, moved outside versioned folders.
 *   - `/versions/<version>/guides/assets/, moved outside versioned folders.
 */
function pathRequiresVersioning(path: string) {
  const isNxenvSdkPage = path.match(new RegExp(SDK_PATH_PATTERN));
  const isNxenvSdkIndexPage = path.match(new RegExp(VERSIONED_PATH_PATTERN + '/$'));
  const isReactNativeApiPage = path.match(new RegExp(REACT_NATIVE_PATH_PATTERN));

  return isNxenvSdkIndexPage || isNxenvSdkPage || isReactNativeApiPage;
}
...
const RENAMED_PAGES: Record<string, string> = {
  ...
  '/introduction/why-not-nxenv/': '/faq/#limitations',
  '/next-steps/community/': '/',
  '/workflow/nxenv-go/': '/get-started/set-up-your-environment/',
  ...
  '/workflow/nxenv-cli/': '/more/nxenv-cli/',
  '/versions/latest/workflow/nxenv-cli/': '/more/nxenv-cli/',
  ...
  '/nxenvkit/': '/archive/glossary/#nxenvkit/',
  ...
  '/guides/nxenvkit/': '/archive/glossary/#nxenvkit/',
  ...
  '/guides/using-electron/':
    'https://dev.to/evanbacon/making-desktop-apps-with-electron-react-native-and-nxenv-5e36',
  ...
  '/introduction/already-used-react-native/':
    '/faq/#what-is-the-difference-between-nxenv-and-react-native',
  ...
  // Redirects after Nxenv Router docs reorganization from Home to Guides
  ...
  // Redirect to expand Nxenv Accounts and permissions
  ...
  '/development/tools/nxenv-dev-client/':
    '/develop/development-builds/introduction/#what-is-nxenv-dev-client',
  ...
  '/workflow/how-nxenv-works/': '/faq/#what-is-the-difference-between-nxenv-and-react-native',
  '/guides/how-nxenv-works/': '/faq/#what-is-the-difference-between-nxenv-and-react-native',
  ...
  '/bare/existing-apps/': '/bare/installing-nxenv-modules/',
  '/bare/installing-unimodules/': '/bare/installing-nxenv-modules/',
  ...
  '/versions/latest/nxenvkit/eject/': '/archive/glossary/#eject',
  '/nxenvkit/eject/': '/archive/glossary/#eject',
  '/nxenvkit/nxenvkit/': '/archive/glossary/#nxenvkit',
  '/submit/classic-builds/': '/submit/introduction/',
  '/technical-specs/nxenv-updates-0/': '/technical-specs/nxenv-updates-1/',
  '/technical-specs/latest/': '/technical-specs/nxenv-updates-1/',
  '/archive/nxenvkit/overview/': '/archive/glossary/',
  '/nxenvkit/overview/': '/archive/glossary/',
  ...
  '/versions/latest/sdk/branch/':
    'https://github.com/nxenv/config-plugins/tree/main/packages/react-native-branch',
  ...
  '/archive/nxenvkit/eject/': '/archive/glossary/#eject',
  ...
  // Stop encouraging usage of Nxenv Go when using native modules
  '/bare/using-nxenv-client/': '/archive/using-nxenv-client/',

  // May 2024 home / get started section
  '/overview/': '/get-started/introduction/',
  '/get-started/installation/': '/get-started/create-a-project/',
  '/get-started/nxenv-go/': '/get-started/set-up-your-environment/',
