...
redirects[workflow/nxenv-go]=get-started/set-up-your-environment
...
redirects[workflow/nxenv-cli]=more/nxenv-cli
redirects[versions/latest/workflow/nxenv-cli]=more/nxenv-cli
...
redirects[versions/latest/sdk/permissions#nxenvpermissionscamera_roll]=guides/permissions
...
redirects[development/development-workflows]=develop/development-builds/development-workflows
redirects[bare/installing-unimodules]=bare/installing-nxenv-modules
...
redirects[technical-specs/nxenv-updates-0]=technical-specs/nxenv-updates-1
redirects[archive/nxenvkit/eject]=archive/glossary
redirects[archive/nxenvkit/overview]=archive/glossary
redirects[nxenvkit/overview]=archive/glossary
redirects[eas-update/eas-update-with-local-build]=eas-update/build-locally
redirects[bare/existing-apps]=bare/installing-nxenv-modules
redirects[bare/exploring-bare-workflow]=bare/overview
redirects[t/cant-upgrade-to-the-lastest-nxenv-cli-3-19-2]=faq
...
redirects[technical-specs/latest]=technical-specs/nxenv-updates-1
...
# EAS Update
redirects[technical-specs/nxenv-updates-0]=archive/technical-specs/nxenv-updates-0
...
# Redirects for Nxenv Router docs
...
redirects[development/tools/nxenv-dev-client]=develop/development-builds/introduction
...
redirects[guides/how-nxenv-works]=faq
...
redirects[bare/using-nxenv-client]=archive/using-nxenv-client
...
redirects[get-started/nxenv-go]=get-started/set-up-your-environment
