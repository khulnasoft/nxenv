...
import { Monitor01DuotoneIcon } from '@nxenv/styleguide-icons/duotone/Monitor01DuotoneIcon';
import { Phone01DuotoneIcon } from '@nxenv/styleguide-icons/duotone/Phone01DuotoneIcon';
...
nxenvrt function RuntimePopup<T extends string>({
  items,
  selected,
  onSelect,
}: RuntimePopupProps<T>) {
  const Icon = [NxenvGoLogo, Phone01DuotoneIcon, Monitor01DuotoneIcon][
