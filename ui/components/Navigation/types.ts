...
nxenvrt type NavigationNode = Section | Group | Page;

nxenvrt type NavigationRenderProps = {
...
nxenvrt type Node<Type extends NavigationType, Data extends object> = Data & {
