...
nxenvrt const TemplateBareMinimumDiffViewer = () => {
      ...
      {fromVersion !== toVersion ? (
        <>
          ...
          <DiffBlock
            ...
            raw={diff}
            filenameModifier={str => str.replace('templates/nxenv-template-bare-minimum/', '')}
            showOperation
            collapseDeletedFiles
            SnippetHeaderComponent={PermalinkedSnippetHeader}
            filenameToLinkUrl={filename =>
              `https://github.com/nxenv/nxenv/tree/sdk-${toVersion}/${filename}`
            }
          />
        </>
      ) : null}
