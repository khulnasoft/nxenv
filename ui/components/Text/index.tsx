import { LinkBase, LinkBaseProps, mergeClasses } from '@nxenv/styleguide';
...
nxenvrt { AnchorContext } from './withAnchor';
...
nxenvrt const createPermalinkedComponent = (
...
nxenvrt function createTextComponent(Element: TextElement, textClassName?: string) {
...
nxenvrt const A = (props: LinkBaseProps & { isStyled?: boolean; shouldLeakReferrer?: boolean }) => {
...
nxenvrt const H1 = createTextComponent(
  TextElement.H1,
  mergeClasses(
...
nxenvrt const RawH2 = createTextComponent(
  TextElement.H2,
  mergeClasses(
...
nxenvrt const RawH3 = createTextComponent(
  TextElement.H3,
  mergeClasses(
...
nxenvrt const RawH4 = createTextComponent(
  TextElement.H4,
  mergeClasses(
...
nxenvrt const RawH5 = createTextComponent(
  TextElement.H5,
  mergeClasses(
...
nxenvrt const P = createTextComponent(
  TextElement.P,
  'font-normal text-[16px] leading-[1.625] tracking-[-0.011rem] [&_strong]:break-words'
);
nxenvrt const CODE = createTextComponent(
  TextElement.CODE,
  mergeClasses(
...
nxenvrt const LI = createTextComponent(
  TextElement.LI,
  mergeClasses('text-[16px] font-normal leading-relaxed tracking-[-0.011rem]', 'mb-2')
);
nxenvrt const HEADLINE = createTextComponent(
  TextElement.P,
  'font-medium text-[16px] leading-[1.625] tracking-[-0.011rem]'
);
nxenvrt const LABEL = createTextComponent(
  TextElement.SPAN,
  'font-medium text-[15px] leading-[1.6] tracking-[-0.009rem]'
);
nxenvrt const CALLOUT = createTextComponent(
  TextElement.P,
  'font-normal text-[14px] leading-[1.5715] tracking-[-0.006rem]'
);
nxenvrt const SPAN = createTextComponent(
  TextElement.SPAN,
  'font-normal text-[14px] leading-[1.5715] tracking-[-0.006rem]'
);
nxenvrt const FOOTNOTE = createTextComponent(
  TextElement.P,
  'font-normal text-[13px] leading-[1.6154] tracking-[-0.003rem]'
);
nxenvrt const CAPTION = createTextComponent(
  TextElement.P,
  'font-normal text-[12px] leading-[1.6154]'
);
nxenvrt const BOLD = createTextComponent(TextElement.SPAN, 'font-semibold');
nxenvrt const DEMI = createTextComponent(TextElement.SPAN, 'font-medium');
nxenvrt const UL = createTextComponent(
  TextElement.UL,
  'list-disc ml-6 [&_ol]:mt-2 [&_ol]:mb-4 [&_ul]:mt-2 [&_ul]:mb-4'
);
nxenvrt const OL = createTextComponent(
  TextElement.OL,
  'list-disc ml-6 [&_ol]:mt-2 [&_ol]:mb-4 [&_ul]:mt-2 [&_ul]:mb-4'
);
nxenvrt const KBD = createTextComponent(
  TextElement.KBD,
  mergeClasses(
...
nxenvrt const MONOSPACE = createTextComponent(TextElement.CODE);
nxenvrt const DEL = createTextComponent(
  TextElement.DEL,
  mergeClasses('line-through [&_code]:line-through')
);

nxenvrt const H2 = createPermalinkedComponent(RawH2, { baseNestingLevel: 2 });
nxenvrt const H3 = createPermalinkedComponent(RawH3, { baseNestingLevel: 3 });
nxenvrt const H4 = createPermalinkedComponent(RawH4, { baseNestingLevel: 4 });
nxenvrt const H5 = createPermalinkedComponent(RawH5, { baseNestingLevel: 5 });
