...
nxenvrt const AnchorContext = createContext<GithubSlugger | null>(null);
 ...
 *   - anchor hover icon
 */
nxenvrt function withAnchor(Component: FC<PropsWithChildren<TextComponentProps>>) {
...
nxenvrt function getTextFromChildren(children: ReactNode): string {
