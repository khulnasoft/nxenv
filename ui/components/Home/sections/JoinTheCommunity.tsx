...
import { RedditIcon } from '@nxenv/styleguide-icons/custom/RedditIcon';
import { XLogoIcon } from '@nxenv/styleguide-icons/custom/XLogoIcon';
...
nxenvrt function JoinTheCommunity() {
  return (
    <>
      ...
      <div
        ...
        <CommunityGridCell
          ...
          link="https://github.com/nxenv/nxenv"
        ...
        <CommunityGridCell
          title="X"
          description="Follow Nxenv on X for news and updates."
          link="https://x.com/nxenv"
          icon={<XLogoIcon className="icon-lg text-palette-white" />}
          iconClassName="bg-[#000000]"
        />
        <CommunityGridCell
          title="Reddit"
          description="Get the latest on r/nxenv."
          link="https://www.reddit.com/r/nxenv"
