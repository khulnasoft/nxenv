...
import { Users02Icon } from '@nxenv/styleguide-icons/outline/Users02Icon';
...
nxenvrt function TalkGridWrapper({ children }: PropsWithChildren) {
  return (
    <div
