import { RouterLogo, mergeClasses } from '@nxenv/styleguide';
      ...
      <GridContainer>
        ...
        <GridCell
          ...
          <RawH2 className="!text-palette-pink11 relative z-10 !text-lg">
            Discover the benefits of file-based routing with Nxenv Router
          </RawH2>
          <HomeButton
        ...
        <GridCell
          ...
          <RawH2 className="!text-palette-purple11 relative z-10 !text-lg">
            Speed up your development with Nxenv Application Services
          </RawH2>
          <HomeButton
