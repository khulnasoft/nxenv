import { mergeClasses, DocsLogo } from '@nxenv/styleguide';
import { CameraPlusDuotoneIcon } from '@nxenv/styleguide-icons/duotone/CameraPlusDuotoneIcon';
import { Image03DuotoneIcon } from '@nxenv/styleguide-icons/duotone/Image03DuotoneIcon';
import { NotificationMessageDuotoneIcon } from '@nxenv/styleguide-icons/duotone/NotificationMessageDuotoneIcon';
...
nxenvrt function ExploreAPIs() {
  return (
    <>
      <RawH3>Explore APIs</RawH3>
      <HeaderDescription>
        Nxenv supplies a vast array of SDK modules. You can also create your own.
      </HeaderDescription>
      <div
