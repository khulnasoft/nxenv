import { TerminalSquareIcon } from '@nxenv/styleguide-icons/outline/TerminalSquareIcon';
...
nxenvrt const Terminal = ({ cmd, cmdCopy, hideOverflow, title = 'Terminal' }: TerminalProps) => (
