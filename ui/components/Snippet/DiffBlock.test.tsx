...
const DIFF_PATH = '/static/diffs/nxenv-ios.diff';
...
const validateDiffContent = (screen: Screen) => {
  ...
  expect(screen.getByText('#import <Nxenv/Nxenv.h>')).toBeInTheDocument();
};
...
diff --git a/templates/nxenv-template-bare-minimum/__tests__/App.js b/templates/nxenv-template-bare-minimum/__tests__/App.js
deleted file mode 100644
index fa45c70206..0000000000
--- a/templates/nxenv-template-bare-minimum/__tests__/App.js
+++ /dev/null
@@ -1,10 +0,0 @@
-import 'react-native';
