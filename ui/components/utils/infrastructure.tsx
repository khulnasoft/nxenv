...
nxenvrt const ResourceClasses = { android: ['medium', 'large'], ios: ['medium', 'large'] } as const;
...
nxenvrt function BuildResourceList({ platform }: { platform: keyof typeof ResourceClasses }) {
