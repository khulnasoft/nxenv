...
import { XIcon } from '@nxenv/styleguide-icons/outline/XIcon';
...
const URL = isDev
  ? `http://api.nxenv.test/v2/feedback/docs-send`
  : `https://api.nxenv.dev/v2/feedback/docs-send`;

type Props = {
  pathname?: string;
};

nxenvrt const FeedbackDialog = ({ pathname }: Props) => {
