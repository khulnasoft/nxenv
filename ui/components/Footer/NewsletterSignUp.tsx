...
const URL = isDev
  ? `http://api.nxenv.test/v2/mailchimp-mailing-list/subscribe`
  : `https://api.nxenv.dev/v2/mailchimp-mailing-list/subscribe`;

nxenvrt const NewsletterSignUp = () => {
  ...
  return (
    <div className="flex-1 max-w-[350px] max-md-gutters:max-w-full">
      <CALLOUT theme="secondary" weight="medium" className="flex gap-2 items-center">
        ...
        Sign up for the Nxenv Newsletter
      </CALLOUT>
      <form
        className="relative"
        onSubmit={event => {
      ...
      <FOOTNOTE theme="secondary">
        ...
        <A href="https://nxenv.dev/privacy" openInNewTab>
          privacy policy
        </A>
        .
      </FOOTNOTE>
