import { LinkBase, mergeClasses } from '@nxenv/styleguide';
...
nxenvrt const Footer = ({
  ...
  const isNxenvPackage = packageName ? packageName.startsWith('nxenv-') : isAPIPage;

  const shouldShowModifiedDate = !isNxenvPackage && !isTutorial;
      ...
      <div
        ...
        <div>
          ...
          <UL className="flex-1 !mt-0 !ml-0 !list-none">
            ...
            {title && isAPIPage && (
              <IssuesLink title={title} repositoryUrl={isNxenvPackage ? undefined : sourceCodeUrl} />
            )}
