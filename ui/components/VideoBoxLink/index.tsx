...
import { PlaySolidIcon } from '@nxenv/styleguide-icons/solid/PlaySolidIcon';
...
nxenvrt function VideoBoxLink({ title, description, videoId, className }: VideoBoxLinkProps) {
  return (
    <A
      openInNewTab
