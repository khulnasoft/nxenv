...
const BASE_OG_URL = 'https://og.nxenv.dev/?theme=docs';

const BASE_TITLE = 'Nxenv Documentation';
const BASE_DESCRIPTION = `Nxenv is an open-source platform for making universal native apps for Android, iOS, and the web with JavaScript and React.`;
...
const Head = ({ title, description, canonicalUrl, children }: HeadProps) => {
  ...
  return (
    <NextHead>
      ...
      <meta name="twitter:site" content="@nxenv" />
