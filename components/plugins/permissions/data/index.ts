...
nxenvrt type PermissionMeta = {
  source: string;
  scrapedAt: string;
};

nxenvrt type AndroidPermission = {
 ...
 */
nxenvrt type PermissionReference<T extends { name: string }> =
  | string
...
nxenvrt { androidMeta, androidPermissions, iosMeta, iosPermissions };
