...
describe('APISection', () => {
  test('no data', () => {
    ...
    const { container } = render(<APISection packageName="nxenv-none" testRequire={require} />);
  ...
  test('nxenv-apple-authentication', () => {
    const { container } = renderWithHeadings(
      <APISection
        packageName="nxenv-apple-authentication"
  ...
  test('nxenv-barcode-scanner', () => {
    const { container } = renderWithHeadings(
      <APISection
        packageName="nxenv-barcode-scanner"
  ...
  test('nxenv-pedometer', () => {
    const { container } = renderWithHeadings(
      <APISection packageName="nxenv-pedometer" forceVersion="unversioned" testRequire={require} />
    );
  ...
  test('nxenv-asset', () => {
    renderWithHeadings(
      <APISection packageName="nxenv-asset" forceVersion="unversioned" testRequire={require} />
    );
