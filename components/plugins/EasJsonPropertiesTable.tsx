...
nxenvrt function formatSchema(rawSchema: Property[]) {
...
nxenvrt function _getType(property: Property) {
  if (property.enum) {
...
nxenvrt function createDescription(property: Property) {
...
nxenvrt const EasJsonPropertiesTable = ({ schema }: Props) => {
