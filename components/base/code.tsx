import { mergeClasses, Themes } from '@nxenv/styleguide';
import { FileCode01Icon } from '@nxenv/styleguide-icons/outline/FileCode01Icon';
import { LayoutAlt01Icon } from '@nxenv/styleguide-icons/outline/LayoutAlt01Icon';
import { Server03Icon } from '@nxenv/styleguide-icons/outline/Server03Icon';
...
nxenvrt function Code({ className, children, title }: CodeProps) {
...
nxenvrt const CodeBlock = ({ children, theme, className, inline = false }: CodeBlockProps) => {
