 ...
 */
nxenvrt async function addMultipleGifs(gifIds: string[]) {
  try {
 ...
 */
nxenvrt async function getSingleGif(gifId: string) {
  await ensureDirExists();
...
/**
 * Nxenvrts shareable URI - it can be shared outside your app
 */
nxenvrt async function getGifContentUri(gifId: string) {
 ...
 */
nxenvrt async function deleteAllGifs() {
