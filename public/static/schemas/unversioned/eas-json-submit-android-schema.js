nxenvrt default [
  {
    ...
    type: 'string',
    description: ['Path to the JSON file with [Google Service Account Key](https://nxenv.fyi/creating-google-service-account) used to authenticate with Google Play.'],
  },
  {
    name: 'track',
  ...
  },
  {
    ...
    type: 'string',
    description: [
      'The application ID that is used when accessing Service Account Key managed by Nxenv. It does not have any effect if you are using local credentials. In most cases this value will be autodetected. However, if you have multiple product flavors, this value might be necessary.',
    ],
  },
];
