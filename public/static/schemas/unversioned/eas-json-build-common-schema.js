nxenvrt default [
  ...
  },
  {
    ...
    description: [
      ...
      "- `internal` - with this option you'll be able to share your build URLs with anyone, and they will be able to install the builds to their devices straight from the Nxenv website. When using `internal`, make sure the build produces a **.apk** or **ipa** file. Otherwise, the shareable URL will be not work. See [internal distribution](/build/internal-distribution) for more information.",
  ...
  },
  {
    ...
    description: [
      ...
      'For the build to be successful, the project must have [`nxenv-dev-client`](/versions/latest/sdk/dev-client/) installed and configured.',
      '',
  ...
  },
  {
    ...
    type: 'string',
    description: [
      'Optional override of the [prebuild](/more/nxenv-cli/#prebuild) command used by EAS.',
      '',
  ...
  },
  {
    ...
    type: 'string',
    description: [
      '**Deprecated**: Version of [`nxenv-cli`](https://www.npmjs.com/package/nxenv-cli) used to [prebuild](/more/nxenv-cli/#prebuild) your app. It only affects managed projects on Nxenv SDK 45 and lower.',
      '',
      'For newer SDKs, EAS Build will use the versioned [Nxenv CLI](/more/nxenv-cli/). It is included with `nxenv` library. You can opt out of using the versioned Nxenv CLI by setting the `NXENV_USE_LOCAL_CLI=0` environment variable in the build profile.',
    ],
  },
  {
    name: 'env',
  ...
  },
  {
    ...
    description: [
      ...
      '',
      'When enabled, for Android, bumps `nxenv.android.versionCode` (for example, `3`to `4`). For iOS, bumps the last component of `nxenv.ios.buildNumber` (for example, `1.2.3.39` to `1.2.3.40`).',
    ],
  },
  {
    name: 'cache',
