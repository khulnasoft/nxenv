...
nxenvrt default [
  ...
  },
  {
    ...
    description: [
      ...
      '',
      'Allowed values:',
      ' - `"version"` - bumps the patch of `nxenv.version` (for example, `1.2.3` to `1.2.4`).',
      ' - `"buildNumber"` (or `true`) - bumps the last component of `nxenv.ios.buildNumber` (for example, `1.2.3.39` to `1.2.3.40`).',
  ...
  },
  {
    ...
    description: [
      ...
      ' - For an Nxenv project, the value is `"Release"` or `"Debug"`. Defaults to `"Release"`.',
