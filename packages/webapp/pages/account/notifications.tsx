import { Checkbox } from '@nxenv/shared/src/components/fields/Checkbox';
import { Switch } from '@nxenv/shared/src/components/fields/Switch';
import React, { ReactElement, SetStateAction, useState } from 'react';
import { cloudinaryNotificationsBrowser } from '@nxenv/shared/src/lib/image';
import CloseButton from '@nxenv/shared/src/components/CloseButton';
import Pointer, {
  PointerColor,
} from '@nxenv/shared/src/components/alert/Pointer';
import useProfileForm from '@nxenv/shared/src/hooks/useProfileForm';
...
import { ButtonSize } from '@nxenv/shared/src/components/buttons/Button';
import { SendType, usePersonalizedDigest } from '@nxenv/shared/src/hooks';
import usePersistentContext from '@nxenv/shared/src/hooks/usePersistentContext';
import { usePushNotificationContext } from '@nxenv/shared/src/contexts/PushNotificationContext';
import { usePushNotificationMutation } from '@nxenv/shared/src/hooks/notifications';
import { Radio } from '@nxenv/shared/src/components/fields/Radio';
import { HourDropdown } from '@nxenv/shared/src/components/fields/HourDropdown';
import { UserPersonalizedDigestType } from '@nxenv/shared/src/graphql/users';
import { isNullOrUndefined } from '@nxenv/shared/src/lib/func';
import { SimpleTooltip } from '@nxenv/shared/src/components/tooltips';
import { useReadingStreak } from '@nxenv/shared/src/hooks/streaks';
import { ReadingStreakIcon } from '@nxenv/shared/src/components/icons';
import { IconSize } from '@nxenv/shared/src/components/Icon';
import { TimezoneDropdown } from '@nxenv/shared/src/components/widgets/TimezoneDropdown';
import { ToggleWeekStart } from '@nxenv/shared/src/components/widgets/ToggleWeekStart';
import { getUserInitialTimezone } from '@nxenv/shared/src/lib/timezones';
            ...
            <div className="relative mt-6 w-full rounded-16 border border-accent-cabbage-default">
              ...
              <div className="relative flex flex-row overflow-hidden p-4">
                <p className="flex-1 break-words typo-subhead">
                  ...
                  discussions, upvotes, replies or mentions on nxenv.khulnasoft.com!
                </p>
                <img
