...
const seo: NextSeoProps = {
  ...
  description:
    'Join the conversation with the most discussed posts on nxenv.khulnasoft.com. See what’s sparking the hottest debates and active discussions among developers.',
};
