...
import { useSquadCategories } from '@nxenv/shared/src/hooks/squads/useSquadCategories';
import { SquadsDirectoryFeed } from '@nxenv/shared/src/components/cards/squad/SquadsDirectoryFeed';
import { NextSeo } from 'next-seo';
import { useViewSize, ViewSize } from '@nxenv/shared/src/hooks';
import {
  Typography,
  TypographyType,
} from '@nxenv/shared/src/components/typography/Typography';
import { IconSize } from '@nxenv/shared/src/components/Icon';
import { SourceIcon } from '@nxenv/shared/src/components/icons';
...
const seo: NextSeoProps = {
  ...
  description:
    'Browse and join Squads on nxenv.khulnasoft.com. Connect with fellow developers, share knowledge, and dive into specific topics of interest in your favorite Squads.',
};
