...
import { SquadPageHeader } from '@nxenv/shared/src/components/squads/SquadPageHeader';
import SquadFeedHeading from '@nxenv/shared/src/components/squads/SquadFeedHeading';
import {
  BaseFeedPage,
  FeedPageLayoutList,
...
} from '@nxenv/shared/src/graphql/squads';
import {
  BasicSourceMember,
  Squad,
...
import useSidebarRendered from '@nxenv/shared/src/hooks/useSidebarRendered';
...
import { PublicProfile } from '@nxenv/shared/src/lib/user';
import { GET_REFERRING_USER_QUERY } from '@nxenv/shared/src/graphql/users';
import { OtherFeedPage, StaleTime } from '@nxenv/shared/src/lib/query';
...
const SquadEmptyScreen = dynamic(
  () =>
    import(
      /* webpackChunkName: "squadEmptyScreen" */ '@nxenv/shared/src/components/squads/SquadEmptyScreen'
    ),
);
...
const SquadLoading = dynamic(
  () =>
    import(
      /* webpackChunkName: "squadLoading" */ '@nxenv/shared/src/components/errors/SquadLoading'
    ),
  { ssr: false },
);
