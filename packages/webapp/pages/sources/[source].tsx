...
import type { TagsData } from '@nxenv/shared/src/graphql/feedSettings';
...
import { useOnboarding } from '@nxenv/shared/src/hooks/auth';
...
import { ActiveFeedNameContext } from '@nxenv/shared/src/contexts/ActiveFeedNameContext';
...
const SourcePage = ({ source }: SourcePageProps): ReactElement => {
  ...
  const seo: NextSeoProps = {
    title: `${source.name} posts on nxenv.khulnasoft.com`,
