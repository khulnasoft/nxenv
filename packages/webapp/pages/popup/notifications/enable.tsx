...
import NotificationToggleIcon from '@nxenv/shared/src/components/icons/NotificationToggle/primary.svg';
import classed from '@nxenv/shared/src/lib/classed';
import { postWindowMessage } from '@nxenv/shared/src/lib/func';
import { ENABLE_NOTIFICATION_WINDOW_KEY } from '@nxenv/shared/src/hooks/useNotificationPermissionPopup';
import { useRouter } from 'next/router';
import { NotificationPromptSource } from '@nxenv/shared/src/lib/log';
...
import { isChrome } from '@nxenv/shared/src/lib/constants';

const BrowserPermissionIcon: ComponentType<{ className: string }> = dynamic(
  () =>
    import(
      /* webpackChunkName: "browserPermissionIcon" */ '@nxenv/shared/src/components/icons/BrowserPermission/primary.svg'
    ),
);
const ChromePermissionIcon: ComponentType<{ className: string }> = dynamic(
  () =>
    import(
      /* webpackChunkName: "browserPermissionIcon" */ '@nxenv/shared/src/components/icons/BrowserPermission/chrome.svg'
    ),
);
