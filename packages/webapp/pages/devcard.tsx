...
import { RadioItem } from '@nxenv/shared/src/components/fields/RadioItem';
import {
  Button,
  ButtonSize,
  ButtonVariant,
...
import { ActiveTabIndicator } from '@nxenv/shared/src/components/utilities';
import { NextSeoProps } from 'next-seo/lib/types';
import { NextSeo } from 'next-seo';
import DevCardPlaceholder from '@nxenv/shared/src/components/DevCardPlaceholder';
import { AuthTriggers } from '@nxenv/shared/src/lib/auth';
import { devCard } from '@nxenv/shared/src/lib/constants';
import {
  DevCardTheme,
  DevCardType,
...
} from '@nxenv/shared/src/components/profile/devcard';
import { DevCardFetchWrapper } from '@nxenv/shared/src/components/profile/devcard/DevCardFetchWrapper';
import { WidgetContainer } from '@nxenv/shared/src/components/widgets/common';
...
import {
  DevCardQueryData,
  useDevCard,
} from '@nxenv/shared/src/hooks/profile/useDevCard';
import { SimpleTooltip } from '@nxenv/shared/src/components/tooltips';
import { ClickableText } from '@nxenv/shared/src/components/buttons/ClickableText';
...
import { downloadUrl } from '@nxenv/shared/src/lib/blob';
import { checkLowercaseEquality } from '@nxenv/shared/src/lib/strings';
  ...
  return (
    <>
      ...
      <p className="mt-4 max-w-[23.5rem] text-center text-text-secondary typo-callout">
        ...
        Generate a DevCard to showcase your activity on nxenv.khulnasoft.com, including
...
const Step2 = ({ initialDevCardSrc }: Step2Props): ReactElement => {
  ...
  const embedCode = useMemo(
    () =>
      `<a href="https://app.nxenv.khulnasoft.com/${
        user?.username
            ...
            {selectedTab === 0 && (
              <>
                <p className="text-text-tertiary typo-callout">
                  Show off your nxenv.khulnasoft.com activity easily by adding your DevCard
