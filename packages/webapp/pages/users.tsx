...
import { LEADERBOARD_QUERY } from '@nxenv/shared/src/graphql/leaderboard';
import { useRouter } from 'next/router';
import { BreadCrumbs } from '@nxenv/shared/src/components/header';
import { SquadIcon } from '@nxenv/shared/src/components/icons';
...
import {
  UserLeaderboard,
  UserTopList,
} from '@nxenv/shared/src/components/cards/Leaderboard';
import {
  CompanyLeaderboard,
  CompanyTopList,
} from '@nxenv/shared/src/components/cards/Leaderboard/CompanyTopList';
...
const seo: NextSeoProps = {
  ...
  description:
    'Check out the top developer leaderboards on nxenv.khulnasoft.com. See the best performers, longest streaks, top referrers, and community leaders.',
};
