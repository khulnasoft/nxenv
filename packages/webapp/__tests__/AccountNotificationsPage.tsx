...
import loggedUser from '@nxenv/shared/__tests__/fixture/loggedUser';
import {
  act,
  fireEvent,
  render,
...
import { BootApp, Visit } from '@nxenv/shared/src/lib/boot';
import { NotificationsContextProvider } from '@nxenv/shared/src/contexts/NotificationsContext';
import { UpdateProfileParameters } from '@nxenv/shared/src/hooks/useProfileForm';
import {
...
import { ApiError } from '@nxenv/shared/src/graphql/common';
import LogContext from '@nxenv/shared/src/contexts/LogContext';
import { SendType } from '@nxenv/shared/src/hooks';
import SettingsContext from '@nxenv/shared/src/contexts/SettingsContext';
import { settingsContext } from '@nxenv/shared/__tests__/helpers/boot';
