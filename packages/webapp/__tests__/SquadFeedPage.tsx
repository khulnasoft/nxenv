...
describe('squad header bar', () => {
  ...
  it('should copy invitation link', async () => {
    ...
    const invitation = `https://app.nxenv.khulnasoft.com/squads/webteam/3ZvloDmEbgiCKLF_eDg72JKLRPgp6MOpGDkh6qTRFr8`;
    await waitFor(() =>
  ...
  it('should copy invitation link for public squad', async () => {
    ...
    const invitation = `https://app.nxenv.khulnasoft.com/squads/webteam?cid=squad&userid=u1`;
    await waitFor(() =>
      expect(window.navigator.clipboard.writeText).toBeCalledWith(invitation),
    );
  });
