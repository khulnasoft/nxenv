...
import ActivitySection from '@nxenv/shared/src/components/profile/ActivitySection';
import { smallPostImage } from '@nxenv/shared/src/lib/image';
import {
  Button,
  ButtonColor,
  ButtonVariant,
} from '@nxenv/shared/src/components/buttons/Button';
import { LazyImage } from '@nxenv/shared/src/components/LazyImage';
...
const KeywordSynonymModal = dynamic(
  () =>
    import(
      /* webpackChunkName: "keywordSynonymModal" */ '@nxenv/shared/src/components/modals/KeywordSynonymModal'
    ),
);
