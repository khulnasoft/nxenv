import { providerMap } from '@nxenv/shared/src/components/auth/common';
import {
  Button,
  ButtonColor,
  ButtonSize,
...
import { LockIcon, MailIcon } from '@nxenv/shared/src/components/icons';
import AccountDangerZone from '@nxenv/shared/src/components/profile/AccountDangerZone';
...
import {
  ...
  KRATOS_ERROR,
  KratosProviderData,
} from '@nxenv/shared/src/lib/kratos';
import { PasswordField } from '@nxenv/shared/src/components/fields/PasswordField';
...
import { useSignBack } from '@nxenv/shared/src/hooks/auth/useSignBack';
import { useEventListener } from '@nxenv/shared/src/hooks';
import { capitalize } from '@nxenv/shared/src/lib/strings';
import { BOOT_LOCAL_KEY } from '@nxenv/shared/src/contexts/common';
  ...
  return (
    <AccountPageContainer title="Security">
      <AccountContentSection
        ...
        title="Account email"
        description="The email address associated with your nxenv.khulnasoft.com account"
      >
        <SimpleTooltip
          placement="bottom"
      ...
      <AccountLoginSection
        ...
        description="Add more accounts to ensure you never lose access to your nxenv.khulnasoft.com
      ...
      <AccountLoginSection
        ...
        description="Remove the connection between nxenv.khulnasoft.com and authorized login providers."
