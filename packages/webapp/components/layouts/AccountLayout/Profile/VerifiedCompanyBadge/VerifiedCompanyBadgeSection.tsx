import { ProfilePicture } from '@nxenv/shared/src/components/ProfilePicture';
import {
  Typography,
  TypographyColor,
  TypographyTag,
...
import Alert, {
  AlertParagraph,
  AlertType,
} from '@nxenv/shared/src/components/widgets/Alert';
...
import { UserCompany } from '@nxenv/shared/src/lib/userCompany';
import {
  generateQueryKey,
  RequestKey,
} from '@nxenv/shared/src/lib/query';
import { useUserCompaniesQuery } from '@nxenv/shared/src/hooks/userCompany';
import { useToastNotification } from '@nxenv/shared/src/hooks';
import { usePrompt } from '@nxenv/shared/src/hooks/usePrompt';
