...
import { ProfileSettingsMenu } from '@nxenv/shared/src/components/profile/ProfileSettingsMenu';
import {
  generateQueryKey,
  RequestKey,
} from '@nxenv/shared/src/lib/query';
import { useViewSize, ViewSize } from '@nxenv/shared/src/hooks';
import { useQueryState } from '@nxenv/shared/src/hooks/utils/useQueryState';
...
import AuthOptions from '@nxenv/shared/src/components/auth/AuthOptions';
import useAuthForms from '@nxenv/shared/src/hooks/useAuthForms';
