...
import type { MainFeedLayoutProps } from '@nxenv/shared/src/components/MainFeedLayout';
...
import { getFeedName as getFeedNameLib } from '@nxenv/shared/src/lib/feed';
...
const MainFeedLayout = dynamic(
  () =>
    import(
      /* webpackChunkName: "mainFeedLayout" */ '@nxenv/shared/src/components/MainFeedLayout'
    ),
  { ssr: true },
);
