...
import { SearchProviderEnum } from '@nxenv/shared/src/graphql/search';
import { MagicIcon } from '@nxenv/shared/src/components/icons';
import { IconSize } from '@nxenv/shared/src/components/Icon';
import classNames from 'classnames';
import SettingsContext, {
  useSettingsContext,
} from '@nxenv/shared/src/contexts/SettingsContext';
import styles from '@nxenv/shared/src/components/Feed.module.css';
import FeedContext from '@nxenv/shared/src/contexts/FeedContext';
...
const Search = (): ReactElement => {
  ...
  const seo = useMemo(() => {
    if ('q' in query) {
      return {
        title: `${query.q} - nxenv.khulnasoft.com post finder`,
      };
    }
    return {
      title: 'nxenv.khulnasoft.com | Where developers grow together',
    };
  }, [query]);
