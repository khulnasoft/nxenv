...
import {
  ...
  SearchResult,
} from '@nxenv/shared/src/components/search';
import { useChat } from '@nxenv/shared/src/hooks';
import { SearchContainer } from '@nxenv/shared/src/components/search/SearchContainer';
import { useRouter } from 'next/router';
import {
  SearchProviderEnum,
  getSearchUrl,
} from '@nxenv/shared/src/graphql/search';
import { cloudinarySearchOg } from '@nxenv/shared/src/lib/image';
    ...
    >
      ...
      {(!!content || !!data) && (
        <div className="flex flex-col justify-center">
          ...
          >
            <span>Search posts on nxenv.khulnasoft.com instead</span>
          </SearchProviderButton>
        </div>
      )}
    </SearchContainer>
