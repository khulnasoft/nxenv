...
import { Post, PostType } from '@nxenv/shared/src/graphql/posts';
...
export const getSeoDescription = (post: Post): string => {
  ...
  if (postTitle) {
    return `Join us to the discussion about "${postTitle}" on nxenv.khulnasoft.com ✌️`;
  }

  return `Join the discussion on nxenv.khulnasoft.com ✌️`;
};
