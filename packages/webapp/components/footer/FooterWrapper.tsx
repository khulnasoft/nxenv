...
const NewComment = dynamic(() =>
  import(
    /* webpackChunkName: "newComment" */ '@nxenv/shared/src/components/post/NewComment'
...
const ScrollToTopButton = dynamic(
  () =>
    import(
      /* webpackChunkName: "scrollToTopButton" */ '@nxenv/shared/src/components/ScrollToTopButton'
    ),
);
