...
// Regex taken from https://github.com/khulnasoft/nxenv-api/blob/234b0be53fea85954403cef5a2326fc50ce498fd/src/common/object.ts#L41
export const handleRegex = new RegExp(/^@?[a-z0-9](\w){2,38}$/i);
// Regex taken from https://github.com/khulnasoft/nxenv-api/blob/234b0be53fea85954403cef5a2326fc50ce498fd/src/common/object.ts#L40
