...
const defaultLoggedUser: LoggedUser = {
  ...
  premium: false,
  reputation: 20,
  image: 'https://nxenv.khulnasoft.com/ido.png',
  ...
  permalink: 'https://nxenv.khulnasoft.com/ido',
  roadmap: 'idoshamun',
  threads: 'idoshamun',
  codepen: 'idoshamun',
  reddit: 'idoshamun',
...
const defaultProfile: PublicProfile = {
  ...
  mastodon: 'https://mastodon.social/@nxenv',
};
  ...
  edges: [
    {
      node: {
        ...
        source: {
          id: 's1',
          name: 'Squad 1',
          image: 'https://nxenv.khulnasoft.com/squad1.png',
          permalink: 'https://nxenv.khulnasoft.com/squad1',
    ...
    },
    {
      node: {
        ...
        source: {
          id: 's2',
          name: 'Squad 2',
          image: 'https://nxenv.khulnasoft.com/squad2.png',
          permalink: 'https://nxenv.khulnasoft.com/squad2',
          type: SourceType.Squad,
          membersCount: 40,
        } as unknown as Squad,
      } as unknown as SourceMember,
...
it('should show twitter link', () => {
  ...
  expect(el).toHaveTextContent('@nxenv');
});
...
it('should show threads link', () => {
  ...
  expect(el).toHaveAttribute('href', 'https://threads.net/@nxenv');
  expect(el).toHaveTextContent('@nxenv');
});
...
it('should show youtube link', () => {
  ...
  expect(el).toHaveAttribute('href', 'https://youtube.com/@nxenv');
  expect(el).toHaveTextContent('@nxenv');
});
...
it('should show mastodon link', () => {
  ...
  expect(el).toHaveAttribute('href', 'https://mastodon.social/@nxenv');
  expect(el).toHaveTextContent('mastodon.social/@nxenv');
});

it('should show portfolio link', async () => {
  renderComponent();
  const el = screen.getByTestId('portfolio');
  expect(el).toHaveAttribute('href', 'https://nxenv.khulnasoft.com/?key=vaue');
  expect(el).toHaveTextContent('nxenv.khulnasoft.com');
});
