...
export const successfulRegistrationMockData: SuccessfulRegistrationData = {
  session: {
    ...
    identity: {
      ...
      traits: {
        email: 'leeeee@nxenv.khulnasoft.com',
        name: 'Lee Solevilla',
        image: '',
        username: '',
      },
      verifiable_addresses: [
        {
          ...
          value: 'leeeee@nxenv.khulnasoft.com',
          verified: false,
          via: 'email',
          status: 'sent',
...
export const settingsFlowMockData: InitializationData & { identity: Identity } =
  {
      ...
      nodes: [
        ...
        },
        {
          ...
          attributes: {
            name: 'traits.email',
            type: 'email',
            value: 'lee@nxenv.khulnasoft.com',
            required: true,
            disabled: false,
            node_type: 'input',
          },
    ...
    identity: {
      ...
      traits: {
        ...
        email: 'lee@nxenv.khulnasoft.com',
        image:
          'https://lh3.googleusercontent.com/a-/AFdZucrCRkShFtfp4KDx2ipH0cgIzKmD7fcDYfwLqX8Q=s96-c',
        username: 'lee',
      },
...
const getWhoamiMockData = (email = 'lee@nxenv.khulnasoft.com') => ({
  verified: true,
  session: {
