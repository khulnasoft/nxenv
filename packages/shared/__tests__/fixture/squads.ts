  ...
  members: Edge<BasicSourceMember>[] = [
    {
      node: {
        user: {
          ...
          permalink: 'https://app.nxenv.khulnasoft.com/elizdev',
        },
      },
    },
    {
      node: {
        user: {
          ...
          permalink: 'https://app.nxenv.khulnasoft.com/capJavert',
        },
      },
    },
    {
      node: {
        user: {
          ...
          permalink: 'https://app.nxenv.khulnasoft.com/Francesco',
        },
      },
    },
    {
      node: {
        user: {
          ...
          permalink: 'https://app.nxenv.khulnasoft.com/vasn',
        },
      },
    },
    {
      node: {
        user: {
          ...
          permalink: 'https://app.nxenv.khulnasoft.com/lee1995',
        },
      },
    },
  ],
...
export const generateTestSquad = (props: Partial<Squad> = {}): Squad => {
  const squad = {
    ...
    handle: 'webteam',
    name: 'Web team',
    permalink: 'https://app.nxenv.khulnasoft.com/squads/webteam',
    public: true,
    type: SourceType.Squad,
  ...
  if (squad.currentMember) {
    if (squad.public) {
      squad.referralUrl = `https://app.nxenv.khulnasoft.com/squads/${squad.handle}?cid=squad&userid=${squad.currentMember.user?.id}`;
    } else {
      squad.referralUrl = `https://app.nxenv.khulnasoft.com/squads/${squad.handle}/${squad.currentMember.referralToken}`;
    }
  }
  ...
  },
  {
    node: {
      ...
      user: {
        ...
        permalink: 'https://app.nxenv.khulnasoft.com/Sab007',
        username: 'Sab007',
        bio: 'Building products @ nxenv.khulnasoft.com',
      },
    },
  },
  {
    node: {
      ...
      user: {
        ...
        permalink: 'https://app.nxenv.khulnasoft.com/denisb0',
        username: 'denisb0',
        bio: null,
      },
    },
  },
  {
    node: {
      ...
      user: {
        ...
        permalink: 'https://app.nxenv.khulnasoft.com/wanderer_007',
  ...
  },
  {
    node: {
      ...
      user: {
        ...
        permalink: 'https://app.nxenv.khulnasoft.com/denizgunsav',
        username: 'denizgunsav',
        bio: 'Visual Brand Designer @ nxenv.khulnasoft.com',
      },
    },
  },
  {
    node: {
      ...
      user: {
        ...
        permalink: 'https://app.nxenv.khulnasoft.com/sshanzel',
        username: 'sshanzel',
        bio: 'Software Engineer @nxenv.khulnasoft.com 👨‍💻  yes! here! 🥳',
      },
    },
  },
  {
    node: {
      ...
      user: {
        ...
        permalink: 'https://app.nxenv.khulnasoft.com/tsahimatsliah2',
        username: 'tsahimatsliah2',
        bio: 'Co-Founder, CDO at nxenv.khulnasoft.com, Designing this platform',
      },
    },
  },
  {
    node: {
      ...
      user: {
        ...
        permalink: 'https://app.nxenv.khulnasoft.com/idoshamun',
        username: 'idoshamun',
  ...
  },
  {
    node: {
      ...
      user: {
        ...
        permalink: 'https://app.nxenv.khulnasoft.com/DailyDevTips',
        username: 'DailyDevTips',
        bio: 'Daily blogger and web team lead at nxenv.khulnasoft.com 💖',
      },
    },
  },
  ...members,
