...
const post: Post = {
  ...
  summary: '',
  permalink: 'https://api.nxenv.khulnasoft.com/r/e3fd75b62cadd02073a31ee3444975cc',
...
export const sharePost: Post = {
  ...
  source: {
    ...
    handle: 'avengers',
    name: 'Avengers',
    permalink: 'https://app.nxenv.khulnasoft.com/squads/avengers',
  ...
  sharedPost: {
    ...
    readTime: 11,
    permalink: 'https://api.nxenv.khulnasoft.com/r/pzSLBZHa1',
    commentsPermalink: 'https://app.nxenv.khulnasoft.com/posts/pzSLBZHa1',
    summary:
    ...
    source: {
      ...
      handle: 'tkdodo',
      name: 'TkDodo',
      permalink: 'https://app.nxenv.khulnasoft.com/sources/tkdodo',
      description: null,
      image:
  ...
  permalink: 'https://api.nxenv.khulnasoft.com/r/5nLQHVNHi',
  numComments: 0,
  numUpvotes: 1,
  commentsPermalink: 'https://app.nxenv.khulnasoft.com/posts/5nLQHVNHi',
  scout: null,
  author: {
