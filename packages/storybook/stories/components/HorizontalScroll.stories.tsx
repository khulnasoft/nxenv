...
import HorizontalScroll from '@nxenv/shared/src/components/HorizontalScroll/HorizontalScroll';
import React, {
  ReactElement,
  RefObject,
  useCallback,
...
import { UnFeaturedSquadCardProps } from '@nxenv/shared/src/components/cards/squad/common/types';
