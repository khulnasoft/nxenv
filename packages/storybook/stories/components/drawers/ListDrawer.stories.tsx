...
import {
  ListDrawer
} from '@nxenv/shared/src/components/drawers/ListDrawer';
...
const meta: Meta<typeof ListDrawer> = {
  ...
  parameters: {
    ...
    design: {
      type: "figma",
      url: "https://www.figma.com/file/nmfWPS7x3kzLUvYMkBx2kW/nxenv.khulnasoft.com---Dev-Mode?node-id=2384%3A21195&mode=dev",
    },
  },
  args: {
