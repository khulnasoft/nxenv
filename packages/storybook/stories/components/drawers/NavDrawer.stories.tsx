...
import { NavDrawer } from '@nxenv/shared/src/components/drawers/NavDrawer';
import {
  AddUserIcon,
  BellIcon,
  CardIcon,
...
const meta: Meta<typeof NavDrawer> = {
  ...
  parameters: {
    ...
    design: {
      type: 'figma',
      url: 'https://www.figma.com/file/nmfWPS7x3kzLUvYMkBx2kW/nxenv.khulnasoft.com---Dev-Mode?node-id=999%3A2766&mode=dev',
    },
  },
  args: {
    header: 'Settings',
