...
import { ADD_FILTERS_TO_FEED_MUTATION } from '@nxenv/shared/src/graphql/feedSettings';
import { UPDATE_ALERTS } from '@nxenv/shared/src/graphql/alerts';
import { UPDATE_USER_SETTINGS_MUTATION } from '@nxenv/shared/src/graphql/settings';
import { MutateFunc } from '@nxenv/shared/src/lib/query';
