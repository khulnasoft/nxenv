...
import { Boot, BootApp } from '@nxenv/shared/src/lib/boot';
import { AuthContextProvider } from '@nxenv/shared/src/contexts/AuthContext';
import { SettingsContextProvider } from '@nxenv/shared/src/contexts/SettingsContext';
import { useRefreshToken } from '@nxenv/shared/src/hooks/useRefreshToken';
import { AlertContextProvider } from '@nxenv/shared/src/contexts/AlertContext';
import { LogContextProvider } from '@nxenv/shared/src/contexts/LogContext';
import Toast from '@nxenv/shared/src/components/notifications/Toast';
...
import {
  ...
  getCompanionWrapper,
} from '@nxenv/shared/src/lib/extension';
import { defaultQueryClientConfig } from '@nxenv/shared/src/lib/query';
import { ReactQueryDevtools } from '@tanstack/react-query-devtools';
import { PromptElement } from '@nxenv/shared/src/components/modals/Prompt';
import { GrowthBookProvider } from '@nxenv/shared/src/components/GrowthBookProvider';
import { NotificationsContextProvider } from '@nxenv/shared/src/contexts/NotificationsContext';
