...
import { MenuIcon } from '@nxenv/shared/src/components/icons';
import classNames from 'classnames';
import React, { MouseEventHandler, ReactElement } from 'react';
import { WithClassNameProps } from '@nxenv/shared/src/components/utilities';
import { combinedClicks } from '@nxenv/shared/src/lib/click';
  ...
  return (
    ...
    >
      {links.map((url, i) => (
        ...
        >
          <img
            src={`https://api.nxenv.khulnasoft.com/icon?url=${encodeURIComponent(
              url,
            )}&size=${iconSize}`}
            alt={url}
