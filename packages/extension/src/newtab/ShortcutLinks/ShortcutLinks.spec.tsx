...
import { mockGraphQL } from '@nxenv/shared/__tests__/helpers/graphql';
...
jest.mock('@nxenv/shared/src/lib/boot', () => ({
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...(jest.requireActual('@nxenv/shared/src/lib/boot') as any),
  getBootData: jest.fn(),
}));
