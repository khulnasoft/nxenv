...
import { getBootData } from '@nxenv/shared/src/lib/boot';
import { graphqlUrl } from '@nxenv/shared/src/lib/config';
import { checkIsChromeOnly, parseOrDefault } from '@nxenv/shared/src/lib/func';
import { GraphQLClient } from 'graphql-request';
import { UPDATE_USER_SETTINGS_MUTATION } from '@nxenv/shared/src/graphql/settings';
import { getLocalBootData } from '@nxenv/shared/src/contexts/BootProvider';
import { getOrGenerateDeviceId } from '@nxenv/shared/src/hooks/log/useDeviceId';
import { install, uninstall } from '@nxenv/shared/src/lib/constants';
...
const excludedCompanionOrigins = [
  'http://127.0.0.1:5002',
  'http://localhost',
  'https://app.nxenv.khulnasoft.com',
  'https://twitter.com',
  ...
  'chrome-extension://',
  'moz-extension://',
  'https://api.nxenv.khulnasoft.com',
];
